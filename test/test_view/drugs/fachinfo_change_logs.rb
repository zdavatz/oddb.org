  ...
  module View
    class TestFachinfoChangelog < Minitest::Test
      ...
      def test_diff_single_item
        ...
        File.write("test_diff_single_item.html", result_single_item.split("<TD").join("\n")) if DEBUG_HTML
      ...
      def test_display_changes_in_item
        ...
        File.write("test_diff_single_item.html", result_change_item.split("<TD").join("\n")) if DEBUG_HTML
      ...
      def test_show_diff_changelog_with_two_items
        ...
        File.write("test_diff.html", result_3_items.split("<TD").join("\n")) if DEBUG_HTML
