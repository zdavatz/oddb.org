...
"
    ...
    def test_change_log_item_utf8
      ...
      @doc.add_change_log_item @oldText, @newText
      item = @doc.change_log[0]
      assert_instance_of ODDB::FachinfoDocument::ChangeLogItem, item
      assert_equal [item], @doc.change_log
      assert_equal @@today, item.time
  ...
  <ul>
    ...
    def test_add_change_log_item_with_time
      @doc.add_change_log_item "old text", "new text", @@one_year_ago
      item = @doc.change_log[0]
      assert_instance_of ODDB::FachinfoDocument::ChangeLogItem, item
      assert_equal [item], @doc.change_log
    ...
    def test_add_change_log_item_with_time_and_options
      ...
      @doc.add_change_log_item "old text", "new text", @@one_year_ago, special_options
      item = @doc.change_log[0]
      assert_instance_of ODDB::FachinfoDocument::ChangeLogItem, item
      assert_equal [item], @doc.change_log
      assert_equal @@one_year_ago, item.time
...
"
    ...
    def test_fachinfo_text_with_table
      ...
      fi = YAML.safe_load_file(file, permitted_classes: [ODDB::FachinfoDocument2001,
        ODDB::Text::Chapter,
        ODDB::Text::Format,
        Symbol,
        ODDB::Text::Table,
      ...
      fi_text = fi.text
      fi.effects.paragraphs[17].rows[5].to_s
