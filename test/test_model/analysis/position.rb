  ...
  module Analysis
    class TestPosition < Minitest::Test
      ...
      def test_delete_footnote
        @position.instance_eval('@footnote = "footnote"', __FILE__, __LINE__)
        assert_equal("footnote", @position.delete_footnote)
      end

      def test_delete_limitation_text
        @position.instance_eval('@limitation_text = "limitation_text"', __FILE__, __LINE__)
        assert_equal("limitation_text", @position.delete_limitation_text)
      end

      def test_delete_list_title
        @position.instance_eval('@list_title = "list_title"', __FILE__, __LINE__)
      ...
      def test_delete_taxnote
        @position.instance_eval('@taxnote = "taxnote"', __FILE__, __LINE__)
