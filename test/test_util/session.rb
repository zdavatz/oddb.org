...
module ODDB
  class TestSession < Minitest::Test
    ...
    def test_limit_queries
      @session.instance_eval('@remote_ip = "remote_ip"', __FILE__, __LINE__)
      @session.instance_eval("@process_start = 0", __FILE__, __LINE__)
      ODDB::Session.class_eval('@@requests = {"remote_ip" => [0,1,2,3,4,5,6]}', __FILE__, __LINE__)
    ...
    def test_interaction_detail
      ...
      @session.interaction_basket_atc_codes
    ...
    def test_choosen_drugs_for_home_interaction
      ...
      @session.instance_eval("@request_path = '/de/gcc/home_interactions/#{UrlForThreePackages}'", __FILE__, __LINE__)
    ...
    def test_choosen_drugs_for_interactions_with_atc_and_iksnr
      ...
      @session.instance_eval("@request_path = '/de/gcc/home_interactions/58392,7680591310011,L02BA01,58643'", __FILE__, __LINE__)
    ...
    def test_choosen_drugs_nothing_found
      ...
      @session.instance_eval("@request_path = '/de/gcc/home_interactions'", __FILE__, __LINE__)
    ...
    def test_get_address_parent_no_parent_in_url
      ...
      @session.instance_eval("@request_path = '/de/gcc/'", __FILE__, __LINE__)
    ...
    def test_change_log_fachinfo
      ...
      @session.instance_eval("@request_path = '/de/gcc/show/fachinfo/#{reg_nr}/diff/#{@@today.strftime("%d.%m.%Y")}'", __FILE__, __LINE__)
