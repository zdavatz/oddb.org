...
module ODDB
  class TestConfig < Minitest::Test
    ...
    def test_method
      @config.instance_eval('@values.store("xxx", "yyy")', __FILE__, __LINE__)
      @config.method(:xxx)
    ...
    def test_method_missing_assignment
      ...
      flexmock("bbb", odba_delete: "odba_delete")
      @config.instance_eval('@values.store("aaa", bbb)', __FILE__, __LINE__)
      assert_equal(xxx, @config.aaa = xxx)
    end

    def test_method_missing__odba_instance_nil
      flexmock("values", odba_instance: nil)
      @config.instance_eval("@values = values", __FILE__, __LINE__)
  ...
  class TestConfigLog < Minitest::Test
    ...
    def test_log_pattern_default_app
      ...
      flexmock(Logger::LogDevice) do |klass|
