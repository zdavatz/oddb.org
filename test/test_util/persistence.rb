...
=begin
This 'requirement' breaks too many other tests for the time being
	def test_initialize_one_step
		pointer = ODDB::Persistence::Pointer.new(:foo, :bar, :baz)
		expected = ODDB::Persistence::Pointer.new([:foo, :bar, :baz])
