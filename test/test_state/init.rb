#!/usr/bin/env ruby
# TestInitState -- oddb -- 13.10.2003 -- maege@ywesee.com
...
class TestInitState < Test::Unit::TestCase
	...
	class StubHome < ODDB::GlobalState; end
	class StubUser
		def home
			StubHome
		end
	...
	def test_init_state
		assert_equal(ODDB::SearchView, @state.view.class)
	end
	def test_trigger_global
		newstate = @state.trigger(:login_form)
		assert_equal(ODDB::LoginState, newstate.class)
