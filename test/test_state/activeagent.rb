#!/usr/bin/env ruby
# TestActiveAgentState -- oddb -- 13.10.2003 -- maege@ywesee.com
...
class TestActiveAgentState < Test::Unit::TestCase
	...
	def setup
		...
		@activeagent.pointer = ODDB::Persistence::Pointer.new(:sequence, :active_agent)
		@sequence = StubSequence.new
		@state = ODDB::ActiveAgentState.new(@session, @activeagent)
	...
	def test_update2
		...
		assert_equal(ODDB::SelectSubstanceState, newstate.class)
		assert_equal(false, @session.app.update_called)
	end
	def test_update3
