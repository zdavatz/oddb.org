    ...
    module Admin
      class TestRegistration < Minitest::Test
        ...
        def test_get_fachinfo
          ...
          assert_kind_of(ODDB::State::Admin::WaitForFachinfo, @reg.instance_eval("get_fachinfo", __FILE__, __LINE__))
        end
        ...
        def test_get_fachinfo__updated_textinfo
          ...
          assert_kind_of(ODDB::State::Admin::Registration, @reg.instance_eval("get_fachinfo", __FILE__, __LINE__))
        end
        ...
        def test_parse_fachinfo__argument_error
          ...
          drb = flexmock("drb", parse_fachinfo_type: "result")
          flexmock(DRb::DRbObject, new: drb)
          assert_kind_of(SBSM::ProcessingError, @reg.instance_eval('parse_fachinfo("type", file)', __FILE__, __LINE__))
        end
        ...
        def test_parse_fachinfo__standard_error
          ...
          drb = flexmock("drb", parse_fachinfo_type: "result")
          flexmock(DRb::DRbObject, new: drb)
          assert_kind_of(StandardError, @reg.instance_eval('parse_fachinfo("type", file)', __FILE__, __LINE__))
        end
