#!/usr/bin/env ruby
# TestMergeCompaniesState -- oddb -- 13.10.2003 -- maege@ywesee.com

$: << File.expand_path('..', File.dirname(__FILE__))
$: << File.expand_path("../../src", File.dirname(__FILE__))

require 'test/unit'
require 'state/mergecompanies'
...
class TestMergeCompaniesState < Test::Unit::TestCase
	...
	def setup
		...
		@state = ODDB::MergeCompaniesState.new(@session, @company)
		@reg = ODDB::Registration.new(10)
		@reg2 = ODDB::Registration.new(11)
	...
	def test_target
		...
		assert_equal(ODDB::CompanyState, newstate.class)
	end
end
