#!/usr/bin/env ruby
# TestInteractionBasketState -- oddb -- 21.06.2004 -- maege@ywesee.com
...
class TestInteractionBasketState < Test::Unit::TestCase
	class App
	...
	def test_calculate_interactions
		...
		state = ODDB::InteractionBasketState.new(session, 'model')
