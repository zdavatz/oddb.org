    ...
    module Companies
      ...
      class TestUserCompanyState < Minitest::Test
        ...
        def test_update1
          ...
          assert_equal(expected, state.instance_eval("@session", __FILE__, __LINE__).instance_eval("@user_input", __FILE__, __LINE__))
        end
      ...
      class TestUserCompany < Minitest::Test
        ...
        def test_validate
          ...
          assert_nil(@state.instance_eval('validate("input")', __FILE__, __LINE__))
        end
