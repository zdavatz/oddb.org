...
class OddbPrevalence
	...
	attr_writer :fachinfos, :orphaned_patinfos, :indices_therapeutici, :invoices, :minifis, :migel_groups, :orphaned_fachinfos, :patinfos, :registrations, :substances, :commercial_forms, :address_suggestions, :atc_classes
