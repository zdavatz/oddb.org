...
Total number of sequences with a correct ATC-code: 0
...
No obsolete sequence '00' found"
    ...
    def test_update_atc_codes
      ...
      seq_56504_1 = flexmock('seq_56504_1', :atc_class => atc_V07,  :atc_class= => nil, :odba_isolated_store => nil)
      ...
      @app.should_receive(:registration).with('54709').and_return(nil)
      ...
      expected = "ODDB::Atc_lessPlugin - Report 15.01.2015
Total time to update: 0.00 [m]
Total number of sequences with a correct ATC-code: 1
