...
module ODDB
  ...
  class TestRefdataPlugin < Minitest::Test
    ...
    def test_update_out_of_trade
      ...
      @plugin.instance_eval("@out_of_trade_false_list = [package]", __FILE__, __LINE__)
      @plugin.instance_eval("@out_of_trade_true_list  = [package]", __FILE__, __LINE__)
      # no debugging log
    ...
    def test_update_pharmacode
      ...
      @plugin.instance_eval("@update_pharmacode_list = [[package, pharmacode]]", __FILE__, __LINE__)
      @plugin.instance_eval("@delete_pharmacode_list = [[package, nil]]", __FILE__, __LINE__)
      # no debugging log
    ...
    def test_report
      ...
      @plugin.instance_eval("@out_of_trade_false_list = [package]", __FILE__, __LINE__)
      @plugin.instance_eval("@out_of_trade_true_list  = [package]", __FILE__, __LINE__)
      @plugin.instance_eval("@delete_pharmacode_list  = [package]", __FILE__, __LINE__)
      @plugin.instance_eval("@update_pharmacode_list  = [package]", __FILE__, __LINE__)
      @plugin.instance_eval("@total_packages  = 123", __FILE__, __LINE__)
      expected = <<~REPORT
    ...
    def test_update_package_trade_status__process1
      ...
      assert_equal(0, @plugin.instance_eval("@out_of_trade_true_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@update_pharmacode_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@delete_pharmacode_list.length", __FILE__, __LINE__))
      assert_equal(1, @plugin.instance_eval("@out_of_trade_false_list.length", __FILE__, __LINE__))
    end
    ...
    def test_update_package_trade_status__process3_status_inactive
      ...
      assert_equal(true, @plugin.update_package_trade_status)
      assert_equal(1, @plugin.instance_eval("@out_of_trade_true_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@out_of_trade_false_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@update_pharmacode_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@delete_pharmacode_list.length", __FILE__, __LINE__))
    end
    ...
    def test_update_package_trade_status__process4
      ...
      assert_equal(0, @plugin.instance_eval("@out_of_trade_false_list.length", __FILE__, __LINE__))
      assert_equal(0, @plugin.instance_eval("@update_pharmacode_list.length", __FILE__, __LINE__))
      assert_equal(1, @plugin.instance_eval("@delete_pharmacode_list.length", __FILE__, __LINE__))
    end
