...
module ODDB
  class TestCsvExportPlugin < Minitest::Test
    ...
    def test_export_index_therapeuticus
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        @plugin.instance_eval("@options = {}", __FILE__, __LINE__)
    ...
    def test__export_drugs
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        ...
        assert_equal(1, @plugin.instance_eval("@counts['originals']", __FILE__, __LINE__))
        assert_equal(1, @plugin.instance_eval("@counts['export_registrations']", __FILE__, __LINE__))
      end
    end
    ...
    def test__export_drugs__dups_empty
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        ...
        assert_equal([0], @plugin.instance_eval("@counts.values.uniq", __FILE__, __LINE__))
      end
    end
    ...
    def test_export_drugs
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        ...
        assert_equal(1, @plugin.instance_eval("@counts['galenic_forms']", __FILE__, __LINE__))
        assert_equal(1, @plugin.instance_eval("@counts['limitations']", __FILE__, __LINE__))
        assert_equal(0, @plugin.instance_eval("@counts['originals']", __FILE__, __LINE__))
      end
    end
    ...
    def test_export_drugs_sl_entry_nil
      flexmock(FileUtils,
        mkdir_p: nil,
        cp: "cp")
      flexmock("limitation_text", de: "de")
      galenic_form = flexmock("galenic_form", description: "description")
      commercial_form = flexmock("commercial_form", de: "de")
      part = flexmock("part",
        multi: "multi",
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        ...
        assert_equal("cp", @plugin.export_drugs)
        assert_equal(1, @plugin.instance_eval("@counts['galenic_forms']", __FILE__, __LINE__))
        assert_equal(0, @plugin.instance_eval("@counts['limitations']", __FILE__, __LINE__))
        assert_equal(0, @plugin.instance_eval("@counts['originals']", __FILE__, __LINE__))
      end
    end
    ...
    def test_export_drugs_extended
      ...
      temporary_replace_constant(@plugin, "ODDB::CsvExportPlugin::EXPORT_SERVER", export_server) do
        ...
        assert_equal(1, @plugin.instance_eval("@counts['routes_of_administration']", __FILE__, __LINE__))
        assert_equal(1, @plugin.instance_eval("@counts['galenic_groups']", __FILE__, __LINE__))
      end
    end
    ...
    def test_export_oddb_dat
      ...
      FileUtils.copy_file(src, dest, preserve: true, verbose: true)
