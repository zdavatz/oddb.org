...
module ODDB
  class TestListener < Minitest::Test
    ...
    def test_text
      @listener.instance_eval('@html="<html>html</html>"', __FILE__, __LINE__)
      expected = "htmltext\ntext"
      assert_equal(expected, @listener.text("text<br />text"))
    end

    def test_text__nil
      @listener.instance_eval("@html=nil", __FILE__, __LINE__)
  ...
  class TestGenericsListener < Minitest::Test
    ...
    def test_tag_start
      ...
      assert_equal("", @listener.instance_eval("@text", __FILE__, __LINE__))
      assert_equal("", @listener.instance_eval("@html", __FILE__, __LINE__))
    end
    ...
    def test_tag_end__OrgGen
      ...
      @listener.instance_eval("@original = package", __FILE__, __LINE__)
      @listener.instance_eval("@generic = package", __FILE__, __LINE__)
    ...
    def test_tag_end__else
      ...
      # check instance variables
      assert_nil(@listener.instance_eval("@text", __FILE__, __LINE__))
      assert_nil(@listener.instance_eval("@html", __FILE__, __LINE__))
    end
  end
  ...
  class TestItCodesListener < Minitest::Test
    ...
    def test_tag_start__ItCode
      ...
      assert_equal(expected, @listener.instance_eval("@pointer", __FILE__, __LINE__))
      assert_equal({}, @listener.instance_eval("@target_data", __FILE__, __LINE__))
      assert_equal({}, @listener.instance_eval("@data", __FILE__, __LINE__))
      target_data_id = @listener.instance_eval("@target_data.object_id", __FILE__, __LINE__)
      data_id = @listener.instance_eval("@data.object_id", __FILE__, __LINE__)
    ...
    def test_tag_start__Limitations
      ...
      # check instance variables
      assert_equal({}, @listener.instance_eval("@target_data", __FILE__, __LINE__))
      assert_equal({}, @listener.instance_eval("@lim_data", __FILE__, __LINE__))
      target_data_id = @listener.instance_eval("@target_data.object_id", __FILE__, __LINE__)
      lim_data_id = @listener.instance_eval("@lim_data.object_id", __FILE__, __LINE__)
    ...
    def test_tag_end__Limitations
      @listener.instance_eval("@target_data = {}", __FILE__, __LINE__)
    ...
    def test_tag_end__ValidFromDate
      ...
      assert_equal({valid_from: nil}, @listener.instance_eval("@target_data", __FILE__, __LINE__))
    end
    ...
    def test_tag_end__Points
      ...
      # check instance variable
      assert_equal({limitation_points: 0}, @listener.instance_eval("@target_data", __FILE__, __LINE__))
    end
  ...
  class TestPreparationsListener < Minitest::Test
    ...
    def test_tag_start__pack
      ...
      @listener.instance_eval("@pac_data = {}", __FILE__, __LINE__)
      @listener.instance_eval("@report_data = {}", __FILE__, __LINE__)
      @listener.instance_eval("@data = {}", __FILE__, __LINE__)
      @listener.instance_eval("@reg_data = {}", __FILE__, __LINE__)
      @listener.instance_eval("@seq_data = {}", __FILE__, __LINE__)
    ...
    def test_tag_start__limitation
      ...
      assert_equal(true, @listener.instance_eval("@in_limitation", __FILE__, __LINE__))
    end
    ...
    def test_tag_end__pack
      ...
      @listener.instance_eval("@sl_entries = {}", __FILE__, __LINE__)
    ...
    def test_tag_end__preparation
      @listener.instance_eval("@deferred_packages = []", __FILE__, __LINE__)
    ...
    def test_tag_end__swissmedic_no_5
      ...
      @listener.instance_eval("@name = name", __FILE__, __LINE__)
    ...
    def test_tag_end__swissmedic_no_8
      @listener.instance_eval("@report = {}", __FILE__, __LINE__)
      @listener.instance_eval('@text = ""', __FILE__, __LINE__)
      flexmock(@app) do |app|
    ...
    def test_tag_end__swissmedic_no_8__out_of_trade
      ...
      @listener.instance_eval('@out_of_trade = "out_of_trade"', __FILE__, __LINE__)
      assert_nil(@listener.tag_end("SwissmedicNo8"))
    end
    ...
    def test_tag_end__StatusTypeCodeSl__2_6
      ...
      @listener.instance_eval("@pack = pack", __FILE__, __LINE__)
    ...
    def test_tag_end__StatusTypeCodeSl__confict
      @listener.instance_eval("@sl_data = {}", __FILE__, __LINE__)
      @listener.instance_eval('@conflict = "conflict"', __FILE__, __LINE__)
      @listener.instance_eval('@out_of_trade = "out_of_trade"', __FILE__, __LINE__)
      assert_nil(@listener.tag_end("StatusTypeCodeSl"))
    end
    ...
    def test_tag_end__description
      @listener.instance_eval('@in_limitation = "in_limitation"', __FILE__, __LINE__)
      @listener.instance_eval("@lim_data = {}", __FILE__, __LINE__)
      @listener.instance_eval('@html = ""', __FILE__, __LINE__)
    ...
    def test_tag_end__description_else
      @listener.instance_eval('@in_limitation = "in_limitation"', __FILE__, __LINE__)
      @listener.instance_eval('@html = ""', __FILE__, __LINE__)
      @listener.instance_eval('@name = {:xx => "name"}', __FILE__, __LINE__)
  ...
  class TestBsvXmlPlugin < Minitest::Test
    ...
    def test_update_preparation__unknown_registration__out_of_trade
      ...
      flexmock("swissindex", search_item: {gtin: TestHelpers::LEVETIRACETAM_GTIN})
    ...
    def test_update_preparation__unknown_package
      ...
      @app.should_receive(:update).and_return do |ptr, data|
        _, res = expected_updates.delete(ptr)
        res
      end
      swissindex = flexmock("swissindex", search_item: {gtin: TestHelpers::LEVETIRACETAM_GTIN})
      server = flexmock("server") do |serv|
