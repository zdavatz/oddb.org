...
module ODDB
  class TestCoMarketingPluginWithFile < Minitest::Test
    ...
    def test_report_with_test_file
      ...
      @plugin.should_receive(:fetch_with_http).once.with(ODDB::CoMarketingPlugin.get_comarketing_url).and_return(File.read(file_name))
      @plugin.update
      assert_nil(result)
      @app.flexmock_verify
 ...
 -> 36130
  ...
  class TestCoMarketingPlugin < Minitest::Test
    ...
    def test_update_registration
      ...
      @plugin.instance_eval("@updated = 0", __FILE__, __LINE__)
    ...
    def test_update_pair
      @plugin.instance_eval("@found = 0", __FILE__, __LINE__)
    ...
    def test_update_pair__not_found
      @plugin.instance_eval("@not_found = []", __FILE__, __LINE__)
    ...
    def test_prune_comarketing
      ...
      flexmock(@app,
        ...
        update: "update")
      @plugin.instance_eval("@deleted = 0", __FILE__, __LINE__)
