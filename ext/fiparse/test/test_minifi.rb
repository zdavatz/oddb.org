...
Le 15 mai 2003, Ospolot® (principe actif: sultiame) a été autorisé pour l'indication suivante: «Epilepsie à paroxysmes rolandiques (épilepsie bénigne de l'enfance avec pointes centro-temporales). Remarque: Si on envisage d'employer le sultiame, il faut tenir compte du fait que l'épilepsie à paroxysmes rolandiques présente un taux élevé de rémissions spontanées et a - même sans traitement médicamenteux - une évolution le plus souvent favorable et un bon pronostic.»
        EOS
