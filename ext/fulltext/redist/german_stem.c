...
static symbol s_1_3[1] = { 0xE4 };
static symbol s_1_4[1] = { 0xF6 };
static symbol s_1_5[1] = { 0xFC };
...
static symbol s_5[] = { 0xE4 };
static symbol s_6[] = { 0xF6 };
static symbol s_7[] = { 0xFC };
static symbol s_8[] = { 'y' };
static symbol s_9[] = { 'u' };
...
static int r_standard_suffix(struct SN_env * z) {
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 78 */
        ...
        z->bra = z->c; /* ], line 79 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab0; /* call R1, line 79 */
            if (ret < 0) return ret;
        }
        switch(among_var) {
            case 0: goto lab0;
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 88 */
        ...
        z->bra = z->c; /* ], line 89 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab1; /* call R1, line 89 */
            if (ret < 0) return ret;
        }
        switch(among_var) {
            case 0: goto lab1;
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 98 */
        z->ket = z->c; /* [, line 99 */
        among_var = find_among_b(z, a_5, 8); /* substring, line 99 */
        if (!(among_var)) goto lab2;
        z->bra = z->c; /* ], line 99 */
        {   int ret = r_R2(z);
            if (ret == 0) goto lab2; /* call R2, line 99 */
            if (ret < 0) return ret;
        }
        switch(among_var) {
            case 0: goto lab2;
            case 1:
                ...
                {   int m = z->l - z->c; (void) m; /* try, line 102 */
                    z->ket = z->c; /* [, line 102 */
                    ...
                    {   int ret = r_R2(z);
                        if (ret == 0) { z->c = z->l - m; goto lab3; } /* call R2, line 102 */
                        if (ret < 0) return ret;
                    }
                    {   
                ...
                break;
            case 2:
                {   int m = z->l - z->c; (void) m; /* not, line 105 */
            ...
            case 3:
                ...
                {   int m = z->l - z->c; (void) m; /* try, line 109 */
                    z->ket = z->c; /* [, line 110 */
                    {   int m = z->l - z->c; (void) m; /* or, line 110 */
                ...
                lab7:
                    z->bra = z->c; /* ], line 110 */
                    {   int ret = r_R1(z);
                        if (ret == 0) { z->c = z->l - m; goto lab6; } /* call R1, line 110 */
                        if (ret < 0) return ret;
                    }
                    {   
...
extern int german_stem(struct SN_env * z) {
    {   int c = z->c; /* do, line 129 */
        {   int ret = r_prelude(z);
            if (ret == 0) goto lab0; /* call prelude, line 129 */
            if (ret < 0) return ret;
        }
    lab0:
        z->c = c;
    ...
    {   int c = z->c; /* do, line 130 */
        {   int ret = r_mark_regions(z);
            if (ret == 0) goto lab1; /* call mark_regions, line 130 */
            if (ret < 0) return ret;
        }
    lab1:
        z->c = c;
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 132 */
        {   int ret = r_standard_suffix(z);
            if (ret == 0) goto lab2; /* call standard_suffix, line 132 */
            if (ret < 0) return ret;
        }
    lab2:
        z->c = z->l - m;
    ...
    {   int c = z->c; /* do, line 133 */
        {   int ret = r_postlude(z);
            if (ret == 0) goto lab3; /* call postlude, line 133 */
            if (ret < 0) return ret;
        }
    lab3:
        z->c = c;
