...
class NullWriter
  ...
  def new_alignment(align)
  end

  def new_font(font)
  end

  def new_margin(margin, level)
  end

  def new_spacing(spacing)
  end

  def new_styles(styles)
  end
