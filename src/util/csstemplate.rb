	...
	class CssTemplate
		...
		FLAVORS = {
			...
			:gerimedi => {
				...
				:bg_bright								=>	'#D5DFF5',
				:bg_dark									=>	'#234896',
				:bg_dark_link_hover_color	=>	'#AAA',
				:bg_feedback							=>	'#F6B2C7',
				:bg_feedback_alternate		=>	'#F6B2C7',
				:bg_google								=>	'#DF376A',
				:bg_medium								=>	'#7bcf88', 
				:bg_navigation						=>	'#234896',
				:body_margin							=>	'0px',
				:explain_font_size				=>	'14px',
				:list_link_hover_color		=>	'#234896',
				:generic_font_color				=>	'#234896',
				:home_link_hover_color		=>	'#234896',
				:rslt_bg									=>	'#E7EBF4',
				:rslt_infos_bg_bright			=>	'#81A2EE',
				:rslt_infos_bg_dark  			=>	'#81A2EE',
				:square_font_size					=>	'14px',
				:std_font_size						=>	'14px',
			},
			:innova => {
				:bg_bright								=>	'#d9fed5',
