#!/usr/bin/env ruby
# State::Drugs::OrphanedPatinfoAssign -- oddb -- 26.11.2003 -- rwaltert@ywesee.com

require 'view/drugs/orphaned_patinfo_assign'

module ODDB
	module State
		module Drugs
class OrphanedPatinfoAssign < State::Drugs::Global
	VIEW = View::Drugs::OrphanedPatinfoAssign
