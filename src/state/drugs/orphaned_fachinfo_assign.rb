#!/usr/bin/env ruby
# State::Drugs::OrphanedFachinfoAssign -- oddb -- 11.12.2003 -- rwaltert@ywesee.com

require 'view/drugs/orphaned_fachinfo_assign'

module ODDB
	module State
		module Drugs
class OrphanedFachinfoAssign < State::Drugs::Global
	VIEW = View::Drugs::OrphanedFachinfoAssign
