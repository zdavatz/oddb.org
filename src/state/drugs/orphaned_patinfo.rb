#!/usr/bin/env ruby
# State::Drugs::OrphanedPatinfo -- oddb -- 20.11.2003 -- rwaltert@ywesee.com

require 'view/drugs/orphaned_patinfo'
require 'state/drugs/patinfo_preview'
require 'state/drugs/orphaned_patinfo_assign'

module ODDB
	module State
		module Drugs
class OrphanedPatinfo < State::Drugs::Global
	VIEW = View::Drugs::OrphanedPatinfo
	def init
		super
	...
	def choice
		...
		if(error?)
			...
			State::Drugs::OrphanedPatinfoAssign.new(@session, lang)
		end
	end
