#!/usr/bin/env ruby
# State::Drugs::AssignDeprivedSequence -- oddb -- 15.12.2003 -- rwaltert@ywesee.com

require 'state/drugs/global'
require 'view/drugs/assign_deprived_sequence'

module ODDB
	module State
		module Drugs
class AssignDeprivedSequence < State::Drugs::Global
	VIEW = View::Drugs::AssignDeprivedSequence
=begin
