...
+41 43 540 05 50
		...
		DICTIONARIES = {
			'de'			=>		{
				...
				:analysis									=>	'Analysenliste',
				:analysis_search_explain	=>	'Analysensuche',
				...
				:base_patent_srid					=>	'Swissreg-ID des Grund-Patentes', 
				:beta											=>	'beta',
				:bracket_close						=>	'&nbsp;)&nbsp;',
				:bracket_open							=>	'&nbsp;(&nbsp;',
				:break										=>	'<br>',
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:explain_analysis_rev_S			=>	'S					=		Position und Analyse gestrichen',
				...
				:explain_comarketing			=>	'Orange&nbsp;=&nbsp;Co-Marketing',
...
',
				...
				:explain_p								=>	'P = Phytotherapeutisches Arzneimittel',
				...
				:hospitals								=>	'Spital',
				:hosting_invoice_date			=>	'Datum Rechnung Hosting',
				:hosting_price						=>	'Preis Hosting',
        ...
        :renewal_flag             =>  'In Erneuerung',
				...
				:swissreg_url0						=>	'http://www.swissreg.ch/servlet/ShowServlet?regid=',
				:swissreg_url1						=>	'&lang=ger',
			...
			'fr'			=>		{
				...
				:amzv											=>	'OEM&eacute;d',
				:analysis									=>	'Liste&nbsp;des&nbsp;analyses',
				:analysis_search_explain	=>	'Recherche d\'analyses',	
				...
				:base_patent_srid					=>	'Swissreg-ID du Brevet de base', 
				:beta											=>	'beta',
				:bracket_close						=>	'&nbsp;)&nbsp;',
				:bracket_open							=>	'&nbsp;(&nbsp;',
				...
				:explain_analysis_rev_S		=>	'S = position et analyse supprim&eacute;es',
				...
				:explain_analysis_tech_AL		=>	'AL			=	liste des analyses',
				:explain_analysis_tech_ALT	=>	'ALT			=	liste des m&eacute;dicaments avec tarif',
				:explain_analysis_tech_Bi		=>	'Bi			=	biopsie',
				:explain_analysis_tech_F		=>	'F				=	selles',
				:explain_analysis_tech_GC		=>	'GC			=	chromatographie gazeuse',
				:explain_analysis_tech_GC_MS	=>	'GC-MS		=	chromatographie gazeuse avec d&eacute;tection par spectrom&eacute;trie de masse',
				:explain_analysis_tech_HPLC		=>	'HPLC		=	chromatographie liquide à haute pression',
				:explain_analysis_tech_HPLC_MS	=>	'HPLC-MS	=	chromatographie liquide à haute pression avec d&eacute;tection par spectrom&eacute;trie de masse',
				...
				:feedback_text_b_bad_migel =>	"Je ne deviens pas ce position de LiMA.",
				:feedback_text_b_good			=>	"Je vais devenir ce m&eacute;dicament.",
				:feedback_text_b_good_migel	=>	"Je vais devenir ce position de LiMA.",
        ...
        :renewal_flag             =>  'En renouvellement',
			...
			'en'			=>		{
				...
				:analysis_search_explain	=>	'Analysis search',
				...
				:base_patent_srid					=>	'Swissreg-ID of Base patent', 
				:beta											=>	'beta',
				:bracket_close						=>	'&nbsp;)&nbsp;',
				:bracket_open							=>	'&nbsp;(&nbsp;',
				:break										=>	'<br>',
			  ...
			  :download_export_descr		=>	'More Information regarding the Master Data',
				...
				:download									=>	'Send',
				:download_analysis0				=>	'To download the full list of analyses in a PDF-file click ',
				...
				:explain_analysis_rev_N			=>	'N					=		new position for new analysis',
				:explain_analysis_rev_Nex		=>	'N,ex			=		new position for existing analysis',
				:explain_analysis_rev_S			=>	'S					=		position and analysis dropped',
				:explain_analysis_rev_TP		=>	'TP				=		taxpointnumber modified',
				:explain_analysis_labarea		=>	'LABORATORY:',
				:explain_analysis_lab_C			=>	'C					=		clinical chemistry',
				:explain_analysis_lab_G			=>	'G					=		medical genetics',
				:explain_analysis_lab_H			=>	'H					=		hematology',
				:explain_analysis_lab_I			=>	'I					=		clinical immunology',
				:explain_analysis_lab_M			=>	'M					=		medical microbiology',
				:explain_analysis_tech_AAS	=>	'AAS			= atomic absorption',
				...
				:explain_analysis_tech_F		=>	'F				=	stool',
				:explain_analysis_tech_GC		=>	'GC			=	gas	chromatography',
				:explain_analysis_tech_GC_MS	=>	'GC-MS		=	gas	chromatography linked with mass spectrometry',
				:explain_analysis_tech_HPLC		=>	'HPLC		=	high pressure liquid chromatography',
				:explain_analysis_tech_HPLC_MS	=>	'HPLC-MS	= high pressure liquid chromatography linked with mass spectrometry',
				:explain_analysis_tech_IEP		=>	'IEP			= immuno-electrophoresis',
				:explain_analysis_tech_IF			=>	'IF			=	immuno-fluorescence',
				:explain_analysis_tech_L			=>	'L				=	liquor',
				...
				:explain_analysis_tech_R			=>	'R				=	result of examination (positive/negative)',
				:explain_analysis_tech_RAST		=>	'RAST		=	radio-allergo-sorbent-test',
				:explain_analysis_tech_RIA		=>	'RIA			=	radioimmunoassay',
				:explain_analysis_tech_S			=>	'S				=	blood',
				:explain_analysis_tech_SL			=>	'SL			=	list of specialities',
				:explain_analysis_tech_sq			=>	'sq			=	semi-quantitative',
				:explain_analysis_tech_ST			=>	'ST			=	quicktest',
				:explain_analysis_tech_U			=>	'U				=	urine',
				:explain_analysis_tech_WB			=>	'WB			=	western blot',
				:explain_comarketing			=>	'Orange&nbsp;=&nbsp;Co-Marketing',
