		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:download_mail_body0			=>	'Hallo ',
				:download_mail_body1			=>	"\n\nSie haben die Daten von ODDB.org runtergeladen. Das freut uns sehr. Ein Feedback Ihrerseits wo Sie die Daten einsetzen wollen, würde uns sehr freuen.\n\nMit freundlichen Grüssen\nZeno Davatz\n",
				:drugs										=>	'Medikamente',
