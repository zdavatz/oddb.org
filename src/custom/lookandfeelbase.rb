		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:fi_quantity0							=>	'Anzahl', 
				:fi_quantity1							=>	' pro Registration <br>(CHF&nbsp;',
				...
				:pi_quantity0							=>	'Anzahl', 
				:pi_quantity1							=>	' pro Sequenz (Dosierung)<br>(CHF&nbsp;',
				:pi_quantity2							=>	'.- / Patienteninfo und Jahr)',
			...
			'fr'			=>		{
				...
				:fi_quantity1							=>	' par Registration <br>(CHF&nbsp;',
				...
				:pi_quantity1							=>	' par S&eacute;quence (Dosage)<br>(CHF&nbsp;',
				...
				:query_limit_explain2			=>	" demandes dans une journée. Nous avons les propositions suivants, pour faire valoir vos droits encore plus:",
			...
			'en'			=>		{
			  ...
			  :download_export_descr		=>	'More Information regarding the Master Data',
				...
				:fi_quantity1							=>	' per Registration <br>(CHF&nbsp;',
				...
				:pi_quantity2							=>	'.- / patient information and year)',
				...
				:query_limit_explain2			=>	" queries in one day. We would like to make the following two suggestions to be able to service your needs in a more professional manner:",
