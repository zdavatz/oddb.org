...
+41 43 540 05 50
		...
		DICTIONARIES = {
			...
			'fr'			=>		{
				...
				:query_limit_explain2			=>	" demandes dans une journée. Nous avons les propositions suivants, pour faire valoir vos droits encore plus.<br>Si vous ne voulez pas des restrictions sur les transmissions vous pouvez utiliser les sites suivantes: <a href=\"http://www.oddb.org/fr/atupri\">caisse maladie Atupri</a>, <a href=\"http://www.provita.ch/pls/provita/pkgapiw.www?p_nodeseq=128\">caisse maladie Provita</a> ou <a href=\"http://www.santesuisse.ch/\">Sant&eacute;suisse</a>.<br>La vue de l\'information professionelle et l'information patient est encore possible pour les informations qui sont publiée sur ODDB.org. Utilisez la champ d'affichage au-dessus.",
			...
			'en'			=>		{
			  ...
			  :download_export_descr		=>	'More Information regarding the Master Data',
				...
				:query_limit_explain2			=>	" queries in one day. We would like to make the following two suggestions to be able to service your needs in a more professional manner.<br>If you do not want any limitations of your queries on ODDB.org, please use the following sites: <a href=\"http://www.oddb.org/en/atupri\">health insurance Atupri</a>, <a href=\"http://www.provita.ch/pls/provita/pkgapiw.www?p_nodeseq=128\">health insurance Provita</a> or <a href=\"http://www.santesuisse.ch\">Sant&eacute;suisse</a>.<br>It is still possible to view the published doctor and comsumer information on ODDB.org. For further searches please use the entry field in the upper right corner of this page.",
