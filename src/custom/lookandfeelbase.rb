		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:download_export_title		=>	'Stammdaten Download - ',
				:download_mail_body0			=>	'Guten Tag ',
				:download_mail_body1			=>	' ',
				:download_mail_body2			=>	".\n\nDie Bezahlung für den Datendownload konnte erfolgreich abgewickelt werden. Mit den folgenden Links können Sie die Daten downloaden:\n\n",
				:download_mail_body3			=>	"\n\nEin Feedback Ihrerseits wie Sie die Daten einsetzen wollen, würde uns sehr freuen.\n\nMit freundlichen Grüssen\nZeno Davatz",
				...
				:paypal_msg_success				=>	'Vielen Dank! Sie können jetzt mit den untigen Links die Daten downloaden. Diese Links wurden Ihnen auch in einem Email zugestellt.',
