	...
	class LookandfeelBase <	SBSM::Lookandfeel
		DICTIONARIES = {
			'de'			=>		{
				...
				:fachinfo_colon						=>	'Fachinformationen:',
				...
				:fi_update								=>	'fi_update',
				:fi_usage									=>	'Dos./Anw.',
				:fipi_activation_charge		=>	"Einmalige Aufschaltgeb&uuml;hren:",
...
=end
			  ...
			  :galdat_download_descr		=>	'oddbdat.tar.gz und oddbdat.zip enthalten die t&auml;glich aktualisierten Artikelstammdaten der ODDB. Die Daten werden von ywesee in das OddbDat-Format umgewandelt und allen gew&uuml;nschten Systemlieferanten von Schweizer Spit&auml;lern zur Verf&uuml;gung gestellt.<br><br>Feedback bitte an zdavatz at ywesee dot com<br><br>-AC (Tabelle 1) - ODDB-Code<br>-ACMED (Tabelle 2) - Weitere Produktinformationen<br>-ACNAM (Tabelle 3)	- Sprachen<br>-ACBARCODE (Tabelle 6) - EAN-Artikelcode<br>-ACPRICEALG (Tabelle 7) - Preise<br>-CODES (Tabelle 11) - Codebeschreibungen (ATC-Beschreibung, Galenische Form)<br>-COMP (Tabelle 12) - Hersteller<br>-ACCOMP (Tabelle 19) - Verbindungstabelle zwischen AC und COMP<br>-SC (Tabelle 40) - Substanzen<br>-ACSC (Tabelle 41) - Verbindungstabelle zwischen AC und SC<br><br>Die Daten werden als oddbdat.tar.gz und oddbdat.zip auf unserem Server bereitgestellt - Vorzugsweise benutzen Sie einen der folgenden direkten Links:<br>',
				...
				:patinfo_colon						=>	'Patienteninformationen:',
				...
				:pub_med									=>	'PubMed',
				:pub_med_href0						=>	"http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?dispmax=20&db=PubMed&pmfilter_EDatLimit=No+Limit&cmd_current=Limits&orig_db=PubMed&cmd=Search&term=cytochrome+AND+p450+AND+",
				:pub_med_href1						=>	"&doptcmdl=DocSum",
			...
			'fr'			=>		{
			  ...
			  :galdat_download_descr		=>	"oddbdat.tar.gz et oddbdat.zip contiennent les donn&eacute;es de base d'articles des ODDB. Ils sont mises &agrave; jour tous les jours. Ywesee converte les donn&eacute;es en OddbDat-Format et les mette &agrave; la disposition pour tout le fournisseur de systèmes des les hôpitaux suisses.<br><br>La r&eacute;troaction demande dessus zdavatz at ywesee dot com<br><br>-AC (Tableau 1) - ODDB-Code<br>-ACMED (Tableau 2) - d'autres informations sur les produits<br>-ACNAM (Tableau 3) - langues<br>-ACBARCODE (Tableau 6) - code d'article EAN<br>-ACPRICEALG (Tableau 7) - prix<br>-CODES (Tableau 11) - descriptions de code (description ATC, forme gal&eacute;nique)<br>-COMP (Tableau 12) - fabricants<br>-ACCOMP (Tableau 19) - tableau de relation entre AC et COMP<br>-SC (Tableau 40) - substances<br>-ACSC (Tableau 41) - tableau de relation entre AC et SC<br><br>Les donn&eacute;es sont fournies oddbdat.tar.gz et oddbdat.zip sur notre serveur - utilisez de pr&eacute;f&eacute;rence &agrave; gauche les directs suivants:",
				:galdat_download_title		=>	'Download des donn&eacute;es de base - oddbdat.tar.gz und oddbdat.zip',
				:galdat_oddb_tar_gz				=>	'oddbdat.tar.gz',
				:galdat_oddb_zip					=>	'oddbdat.zip',
