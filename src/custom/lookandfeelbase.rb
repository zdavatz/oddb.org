...
',
        ...
        :ddd_chart_title0         =>  "Comparaison des coutes quotidiens pour ",
        :ddd_chart_title1         =>  "",
        :ddd_chart_source         =>  "Source: ch.oddb.org",
				...
				:ddd_price_for0           =>	'Co&ucirc;t quotidien pour ',
				:ddd_price_for1           =>	'',
				:ddd_price_title					=>	"Pour la comparaison des co&ucirc;ts quotidiens veuillez cliquer ici",
