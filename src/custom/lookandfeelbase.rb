	...
	class LookandfeelBase <	SBSM::Lookandfeel
		DICTIONARIES = {
			'de'			=>		{
				...
				:add_to_interaction				=>	'Klicken Sie auf Hinzuf&uuml;gen, um das gew&uuml;nschte Produkt zu ihrem Interaktionskorb hinzuzuf&uuml;gen',
				...
				:explain_li								=>	'! = Limitationen',
				:explain_original					=>	'Rot&nbsp;=&nbsp;Original',
				:explain_pbp							=>	'PBP = Publikumspreis, inkl. Mwst.',
				...
				:explain_sl								=>	'SL = Spezialit&auml;tenliste (und LOA)',
				...
				:e_invalid_ikscat0				=>	'"',
				:e_invalid_ikscat1				=>	'" ist keine g&uuml;ltige Kategorie. Bitte &uuml;berpr&uuml;fen Sie die Schreibweise.',
				:e_invalid_ikscd0					=>	'"',
				...
				:e_selfmerge_company			=>	'"Die Registrationen sind dieser Firma bereits zugeonet"',
				...
				:fi_usage									=>	'Dos./Anw.',
				:found_sequences					=>	'Gefundene Medikamente',
				:found_substances					=>	'Gefundene Wirkstoffe',
				:fr												=>	'Fran&ccedil;ais',
=begin
				:gag_order								=>	<<-EOS,
...
=end
			  ...
			  :galdat_download_descr		=>	'Galdat_oddb.tar.gz und Galdat_oddb.zip enthalten die t&auml;glich aktualisierten Artikelstammdaten der ODDB. Die Daten werden von ywesee in das Galdat-Format umgewandelt und allen gew&uuml;nschten Systemlieferanten von Schweizer Spit&auml;lern zur Verf&uuml;gung gestellt.<br><br>Feedback bitte an zdavatz at ywesee dot com<br><br>-AC (Tabelle 1) - ODDB-Code<br>-ACMED (Tabelle 2) - Weitere Produktinformationen<br>-ACNAM (Tabelle 3)	- Sprachen<br>-ACBARCODE (Tabelle 6) - EAN-Artikelcode<br>-ACPRICEALG (Tabelle 7) - Preise<br>-CODES (Tabelle 11) - Codebeschreibungen (ATC-Beschreibung, Galenische Form)<br>-COMP (Tabelle 12) - Hersteller<br>-ACCOMP (Tabelle 19) - Verbindungstabelle zwischen AC und COMP<br>-SC (Tabelle 40) - Substanzen<br>-ACSC (Tabelle 41) - Verbindungstabelle zwischen AC und SC<br><br>Die Daten werden als galdat_oddb.tar.gz und galdat_oddb.zip auf unserem Server bereitgestellt - Vorzugsweise benutzen Sie einen der folgenden direkten Links:<br>',
				:galdat_download_title		=>	'Stammdaten Download - galdat_oddb.tar.gz und galdat_oddb.zip',
				:galdat_oddb_tar_gz				=>	'galdat_oddb.tar.gz',
				:galdat_oddb_zip					=>	'galdat_oddb.zip',
				...
				:generic_definition_text1	=>	'Gem&auml;ss Artikel 14 Absatz 1 Buchstabe a des Heilmittelgesetzes (HMG; SR 812.21) kann das Schweizerische	Heilmittelinstitut (Swissmedic) für bestimmte Kategorien von Arzneimitteln vereinfachte Zulassungsverfahren vorsehen, insbesondere für Arzneimittel mit	bekannten Wirkstoffen. Dies betrifft in erster Linie die Generika. Damit jedoch ein Präparat den Status eines	Generikums für sich in Anspruch nehmen kann, muss	das Zulassungsgesuch eingereicht werden, solange das Originalpr&auml;parat noch über eine Zulassung verfügt.',
				...
				:home											=>	'Home',
				:home_welcome							=>  'Willkommen bei oddb.org, dem<br>aktuellsten Medikamenten-Portal der Schweiz.<br>Die monatliche Aktualisierung erfolgt direkt<br>über die offiziellen Daten vom <a class="welcome" href="http://www.bsv.admin.ch/sl/liste/d/index.htm" target="_blank">BSV</a> und der <a class="welcome" href="http://www.swissmedic.ch/de/industrie/overall.asp?theme=0.00110.00001&amp;theme_id=980" target="_blank">Swissmedic</a>.',
				...
				:interaction_search_explain	=>	"deutsch erklaerung",
				...
				:plugin_description				=>	'F&uuml;r Mozilla, Mozilla-Firebird und Netscape Browser (ab Version 6) gibt es das praktische Generika.cc - Plugin zum download. Mit dem Plugin k&ouml;nnen Sie direkt &uuml;ber den Suchbalken (Mozilla, Netscape) oder das spezielle Suchfenster (Mozilla-Firebird) nach Medikamenten, Herstellern oder Wirkstoffen suchen:',
				:plugin_download_descr		=>	'Linux Benutzer m&uuml;ssen die Berechtigungen f&uuml;r das searchplugins Verzeichnis in ihrem Mozilla Verzeichnis (z.B. chmod 0777 /usr/lib/mozilla/searchplugins) &auml;ndern. Oder folgende zwei Dateien manuell in dieses Verzeichnis (z.B. /usr/lib/mozilla/searchplugins/) kopieren:',
				...
				:th_ikscat								=>	'Kat.',
				:th_ikscat_title					=>	'Swissmedic-Kategorie / SL-Eintrag',
			...
			'fr'			=>		{
				...
				:explain_efb							=>	'EFP = Prix exfactory, TVA excl.',
				:explain_fi								=>	'IT = Informations techniques',
				:explain_generic					=>	'vert&nbsp;=&nbsp;g&eacute;n&eacute;rique',
				:explain_li								=>	'! = Limitations',
				:explain_original					=>	'rouge&nbsp;=&nbsp;original',
				:explain_pbp							=>	'PBP = Prix de public, TVA comp.',
				:explain_pi								=>	'PI = Patienteninformationen',
				...
				:explain_sl								=>	'SL = Liste de sp&eacute;cialit&eacute; (et LOA)',
				...
				:fr												=>	'Fran&ccedil;ais',
				:galdat_download					=>	'Download des donn&eacute;es de base',
			  :galdat_download_descr		=>	"Galdat_oddb.tar.gz et Galdat_oddb.zip contiennent les donn&eacute;es de base d'articles des ODDB. Ils sont mises &agrave; jour tous les jours. Ywesee converte les donn&eacute;es en Galdat-Format et les mette &agrave; la disposition pour tout le fournisseur de systèmes des les hôpitaux suisses.<br><br>La r&eacute;troaction demande dessus zdavatz at ywesee dot com<br><br>-AC (Tableau 1) - ODDB-Code<br>-ACMED (Tableau 2) - d'autres informations sur les produits<br>-ACNAM (Tableau 3) - langues<br>-ACBARCODE (Tableau 6) - code d'article EAN<br>-ACPRICEALG (Tableau 7) - prix<br>-CODES (Tableau 11) - descriptions de code (description ATC, forme gal&eacute;nique)<br>-COMP (Tableau 12) - fabricants<br>-ACCOMP (Tableau 19) - tableau de relation entre AC et COMP<br>-SC (Tableau 40) - substances<br>-ACSC (Tableau 41) - tableau de relation entre AC et SC<br><br>Les donn&eacute;es sont fournies galdat_oddb.tar.gz et galdat_oddb.zip sur notre serveur - utilisez de pr&eacute;f&eacute;rence &agrave; gauche les directs suivants:",
				:galdat_download_title		=>	'Download des donn&eacute;es de base - galdat_oddb.tar.gz und galdat_oddb.zip',
				:galdat_oddb_tar_gz				=>	'galdat_oddb.tar.gz',
				:galdat_oddb_zip					=>	'galdat_oddb.zip',
				...
				:interaction_search_explain	=>	"francais",
				...
				:plugin										=>	'Plugin',
				:plugin_generika					=>	'Generika.cc - Plugin',
				:plugin_description				=>	'Pour Mozilla, Mozilla-Firebird et Netscape Browser (&agrave; partir de la version 6) il y a le Generika.cc pratique - Plugin download. Avec le Plugin, vous pouvez chercher directement des m&eacute;dicaments, des fabricants ou des agents sur les poutres de recherche (Mozilla, Netscape) ou la fenêtre de recherche sp&eacute;ciale (Mozilla-Firebird) après :',
				...
				:th_company_name					=>	'Firme',
				:th_company_url						=>	'Adresse internet',
				:th_comparable_size				=>	'Taille des pr&eacute;sentations',
			  ...
			  :yaml_export_descr				=>	"oddb.yaml.gz et oddb.yaml.zip contiennent les donn&eacute;es de base d'articles des ODDB. Ils sont mises &agrave; jour tous les jours. Ywesee converte les donn&eacute;es en YAML-Format et les mette &agrave; la disposition pour tout le fournisseur de systèmes des les hôpitaux suisses.",
				:yaml_export_feedback			=>	'La r&eacute;troaction demande dessus zdavatz at ywesee dot com',
				:yaml_export_title				=>	'Download des donn&eacute;es de base - oddb.yaml.gz und oddb.yaml.zip',
				:yaml_link								=>	'www.yaml.org',
