...
+41 43 540 05 50
		...
		DICTIONARIES = {
			'de'			=>		{
				...
				:analysis_search_explain	=>	'Suchen Sie in der Liste der von den Krankenversicherern im Rahmen der obligatorischen Krankenpflegeversicherung als Pflichtleistung zu verg&uuml;tenden Analysen',
...
',
        ...
        :renewal_flag             =>  'In Erneuerung',
			...
			'fr'			=>		{
				...
				:analysis_search_explain	=>	'Cherchez dans la liste des analyses prises en charge par les assureurs-maladie dans le cadre de l\'assurance-maladie obligatoire',	
        ...
        :renewal_flag             =>  'En renouvellement',
			...
			'en'			=>		{
				...
				:analysis_search_explain	=>	'Search the list of analyses which are to be compensated as a compulsory benefit by the health insurances according to the mandatory nursing insurance',
