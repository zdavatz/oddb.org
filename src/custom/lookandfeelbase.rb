...
',
        ...
        :explain_auc_factor_125   =>  '<span class="auc-factor-125"> inhibition faible </span>: causant une montée > 1.25-fois des valeurs AUC de plasma ou une réduction en Clearance de 20-50%.',
				...
				:explain_mail_order_price_title    => 'Project-pilote',
        ...
        :i_patinfo_assigned       =>  'L\'information patient a été assignée.',
				...
				:i_subscriber_mail_sent		=>	"Votre annonce a été envoyée. Si vous n'obtenez pas d'émail dans les prochaines minutes, veuillez réexaminer et essayez de nouveau l'adresse d'émail indiquée vous lui.",
				:i_unsubscriber_mail_sent	=>	"Votre déclaration de départ a été envoyée. Si vous n'obtenez pas d'émail dans les prochaines minutes, veuillez réexaminer et essayez de nouveau l'adresse d'émail indiquée vous lui.",
