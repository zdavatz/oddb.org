...
',
				...
				:explain_search_hc_provider =>"Suchen Sie nach Ärzten, Apotheken und Spitäler in der Schweiz.\nSie können nach GLN (aka EAN13), Name, Adresse, Telefon oder Ortschaft suchen.",
        ...
        :home_welcome_hc_providers =>  'Willkommen bei den Ärzten, Apotheken und Spitälern der Schweiz!',
				:hors_commerce						=>	'a.H.',
        ...
        :hospitals_search_explain =>  'Suchen Sie nach Spital, Ort oder einem Begriff.',
				:hc_provider_count_text		=>	'Ärzte, Apotheken, Spitäler',
				:hc_providerlist					=>	'Arzt-/Apotheke-/Spitalverzeichnis',
				:hc_providers							=>	'Arzt, Apotheke, Spital',
        :hc_providers_search_explain =>  'Suchen Sie nach Arzt, Apotheke, Spital, Ort oder einem Begriff.',
        :howto                    =>  'Anleitung',
