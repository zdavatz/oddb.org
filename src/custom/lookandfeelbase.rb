		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr				=>	'oddb.yaml.gz und oddb.yaml.zip enthalten die t&auml;glich aktualisierten Artikelstammdaten von ODDB.org. Die Daten werden von ywesee im Yaml-Format exportiert und allen interessierten Systemlieferanten von Krankenkassen, Spit&auml;lern, Apotheken, &Auml;rzten, Heimen etc. zur Verf&uuml;gung gestellt. Die Kosten f&uuml;r die Daten sind zur Zeit gleich Null. Bei einer erfolgreichen Implementation mit  den ODDB.org-Daten nehmen wir gerne eine Dienstleistungsgeb&uuml;hr entgegen.',
				...
				:exact_match							=>	'Ich will nur nach dem exakten Medikamentennamen suchen (einmalig!).',
...
=end
				...
				:help_agentsearch					=>	"Suchen nach Wirkstoff",
				:help_agentsearch0				=>	"Auf ",
				:help_agentsearch1				=>	" kann nach der lateinisch-wissenschaftlichen Bezeichnung des Wirkstoffs gesucht werden. ",
				:help_atcsearch						=>	"Suchen mit ATC-Chooser",
				:help_atcsearch_txt				=>	"Der ATC-Chooser erm&ouml;glicht dem Besucher innerhalb der im ATC-Code definierten Fachkategorien zu suchen. Das Resultat enth&auml;lt s&auml;mtliche Pr&auml;parate der gesuchten Fachkategorie. Diese Dienstleistung richtet sich vor allem an das Fachpublikum.",
				:help_companylist_txt	=>	"Im Firmenverzeichnis k&ouml;nnen folgende Angaben gemacht werden: Firmenname, Homepage, Email, Firmenlogo (Bitte nur *.gif oder *.jpg Bild-Dateien von 200px Breite, 100px H&ouml;he und max. 20kB Gr&ouml;sse uploaden), Kontaktperson (Vorname, Nachname, Email), Strasse, Postfach, Telefon, Telefon-Bestellungen, Fax, PLZ/Ort, Land, Ansprechperson und ein kurzer Firmenbeschrieb (max. 500 Zeichen). Als zus&auml;tzlicher Value Added wird der Hersteller im Suchresultat mit dem Firmenverzeichnis verkn&uuml;pft. Der Eintrag im Firmenverzeichnis ist kostenpflichtig.",
				:help_comparison					=>	"Vergleichsfunktion",
				:help_comparison_txt			=>	"Die Vergleichsfunktion erm&ouml;glicht dem Besucher wirkstoffidentische Pr&auml;parate miteinander zu vergleichen. Dosierung und Wirkstoff m&uuml;ssen dabei 100% &uuml;bereinstimmen. Galenische Formen werden gruppiert verglichen. Bei der Packungsgr&ouml;sse ist eine Abweichung von bis zu 15 Einheiten m&ouml;glich. Unterschiede in den Packungsgr&ouml;ssen werden in die Preisberechnung miteinbezogen. ",
				:help_compsearch					=>	"Suchen nach Hersteller",
				:help_compsearch0					=>	"Auf ",
				:help_compsearch1					=>	" kann nach dem Hersteller eines Pr&auml;parats gesucht werden. Das Resultat enth&auml;lt s&auml;mtliche Pr&auml;parate des gesuchten Herstellers. Die Pr&auml;parate sind nach ATC-Code sortiert.",
				:help_namesearch					=>	"Suchen nach Pr&auml;paratenamen",
				:help_namesearch0					=>	"Auf ",
				:help_namesearch1					=>	" kann nach dem Namen des Pr&auml;parats gesucht werden. ",
				:help_possibilities0			=>	'Was man auf ',
				:help_possibilities1			=>	' alles tun kann',
				:help_result_data					=>	"Angaben im Suchresultat",
				:help_result_data_txt			=>	"Das Suchresultat enth&auml;lt folgende Angaben: Preis, Pr&auml;parat, Galenische Form, Dosis, Packungsgr&ouml;sse, Preis, Wirkstoff, Firma, Liste (Spezialit&auml;tenliste / IKS-Klassifizierung) und Limitationen. Preise mit leistungsorientierter Abgeltung in Apotheken (LOA) werden mit einem Sternchen* gekennzeichnet. Pr&auml;parate mit Kompendiumstext werden auf der rechten Seite der Tabelle mit einem K gekennzeichnet.",
				:help_sort								=>	"Sortierfunktion",
				:help_sort_txt						=>	"Die Sortierfunktion erm&ouml;glicht dem Besucher, das Suchresultat auf- oder absteigend zu sortieren. Es kann nach Preis, Pr&auml;parat, Galenische Form, Dosis, Packungs-Gr&ouml;sse, Preis, Wirkstoff, Firma und Liste sortiert werden.<br> Zum sortieren klicken Sie bitte in den Tabellentitel. ",
				:helps										=>	'Wirkung',
				:home											=>	'Home',
				...
				:plugin_description				=>	'F&uuml;r Mozilla, Mozilla-Firefox und Netscape Browser (ab Version 6) gibt es das praktische oddb.org - Plugin zum download. Mit dem Plugin k&ouml;nnen Sie direkt &uuml;ber den Suchbalken (Mozilla, Netscape) oder das spezielle Suchfenster (Mozilla-Firebird) nach Medikamenten, Herstellern oder Wirkstoffen suchen:',
				...
				:plugin_javascript				=>	'Plugin Package-Download',
				:plz											=>	'Postleitzahl',
				:point										=>	'.',
			...
			'fr'			=>		{
				...
				:download_export_descr				=>	"oddb.yaml.gz et oddb.yaml.zip contiennent les donn&eacute;es de base d'articles des ODDB. Ils sont mises &agrave; jour tous les jours. Ywesee converte les donn&eacute;es en YAML-Format et les mette &agrave; la disposition pour tout le fournisseur de syst&egrave;mes des les hôpitaux suisses.",
				:download_export_feedback			=>	'La r&eacute;troaction demande dessus zdavatz at ywesee dot com',
				:download_export_title				=>	'Download des donn&eacute;es de base - oddb.yaml.gz und oddb.yaml.zip',
				:ean13										=>	'EAN',
				...
				:en												=>	'English',
				:exact_match							=>	'Je veux chercher conform&eacute;ment au nom de m&eacute;dicament (une fois!).',
				...
				:help_agentsearch					=>	"Recherche du principe actif",
				:help_agentsearch0				=>	"Sur",
				:help_agentsearch1				=>	"  on peut rechercher d'apr&egrave;s la d&eacute;nomination scientifique en latin du principe actif.",
				:help_atcsearch						=>	"Recherche avec le classification ATC",
				:help_atcsearch_txt				=>	"La classification ATC permet au visiteur de rechercher parmi les cat&eacute;gories sp&eacute;cialis&eacute;es d&eacute;finies dans le code ATC. Le r&eacute;sultat comprend toutes les pr&eacute;parations de la cat&eacute;gorie sp&eacute;cialis&eacute;e recherch&eacute;e. Cette prestation s'adresse surtout au personnel qualifi&eacute;.",
				:help_companylist_txt	=>	"Dans le r&eacute;pertoire des firmes, les indications suivantes peuvent &ecirc;tre mentionn&eacute;es: nom de la firme, Homepage, Email, logo de l'entreprise (s.v.p. charger seulement des fichiers-images *.gif ou *.jpg de 200px de large, 100px de haut et de max. 20kB), personne &agrave; contacter (pr&eacute;nom, nom, Email), rue, case postale, t&eacute;l&eacute;phone, commandes par t&eacute;l&eacute;phone, fax, NPA/localit&eacute;, pays, interlocuteur et une br&egrave;ve description de l'entreprise (max. 500 frappes). Dans le r&eacute;sultat de la recherche, le lien entre le fabricant et le r&eacute;pertoire des firmes constitue une valeur ajout&eacute;e suppl&eacute;mentaire. L'inscription dans le r&eacute;pertoire des firmes est payante. Elle peut &ecirc;tre pay&eacute;e en ligne avec une carte de cr&eacute;dit.",
				:help_comparison					=>	"Fonction de comparaison",
				:help_comparison_txt			=>	"La fonction de comparaison permet au visiteur de comparer deux pr&eacute;parations aux principes actifs identiques. Posologie et principe actif doivent cependant concorder &agrave; 100%. Les formes gal&eacute;niques suivantes sont compar&eacute;es entre elles: gel / cr&egrave;me / onguent / pommade ophtalmique, solution / sirop / suspension, drag&eacute;es-retard / capsules-retard / comprim&eacute;s-retard,  drag&eacute;es / comprim&eacute;s film&eacute;s / capsules / comprim&eacute;s. En ce qui concerne la taille des pr&eacute;sentations, il peut y avoir un &eacute;cart allant jusqu'&agrave; 15 unit&eacute;s. Les diff&eacute;rences dans la taille des pr&eacute;sentations sont prises en consid&eacute;ration dans le calcul des prix.",
				:help_compsearch					=>	"Rechercher d'apr&egrave;s le fabricant",
				:help_compsearch0					=>	"Sur ",
				:help_compsearch1					=>	" on peut rechercher d'apr&egrave;s le fabricant d'une pr&eacute;paration. Le r&eacute;sultat comprend toutes les pr&eacute;parations du fabricant recherch&eacute;. Les pr&eacute;parations sont classifi&eacute;es d'apr&egrave;s le code ATC.",
				:help_namesearch					=>	"Rechercher d'apr&egrave;s le nom de la pr&eacute;paration",
				:help_namesearch0					=>	"Sur ",
				:help_namesearch1					=>	" on peut rechercher d'apr&egrave;s le nom de la pr&eacute;paration.",
				:help_possibilities0			=>	"Tout ce que l'on peut faire sur",
				:help_possibilities1			=>	'',
				:help_result_data					=>	"Donn&eacute;es dans le r&eacute;sultat de la recherche",
				:help_result_data_txt			=>	"Le r&eacute;sultat de la recherche comprend les donn&eacute;es suivantes: prix, pr&eacute;paration, forme gal&eacute;nique, dose, taille des pr&eacute;sentations, prix, principe actif, firme, liste (liste des sp&eacute;cialit&eacute;s / classement OICM) et limitations. Les prix avec r&eacute;mun&eacute;ration bas&eacute;e sur les prestations dans les pharmacies (RBP) sont signal&eacute;s
				avec un ast&eacute;risque*. Les pr&eacute;parations avec le texte du Compendium sont signal&eacute;es sur la droite de la tabelle avec un C.",
				:help_sort								=>	"Fonction de classement",
				:help_sort_txt						=>	"La fonction de classement permet au visiteur de classer le r&eacute;sultat de la recherche en montant ou en descendant. On peut proc&eacute;der au classement par prix, pr&eacute;paration, forme gal&eacute;nique, dose, taille des pr&eacute;sentations, prix, principe actif, fabricant et liste.<br> Pour classer, cliquer s.v.p. sur les titres de la tabelle. ",
				:helps										=>	'Effet',
				:home											=>	'Accueil',
				...
				:plugin										=>	'Plugin',
				:plugin_description				=>	'Pour Mozilla, Mozilla-Firebird et Netscape Browser (&agrave; partir de la version 6) il y a le oddb.org pratique - Plugin download. Avec le Plugin, vous pouvez chercher directement des m&eacute;dicaments, des fabricants ou des agents sur les poutres de recherche (Mozilla, Netscape) ou la fen&ecirc;tre de recherche sp&eacute;ciale (Mozilla-Firebird) apr&egrave;s :',
			...
			'en'			=>		{
				...
				:date_format							=>	'%d.%m.%Y',
				:ddd											=>	'WHO-DDD',
				:ddd_count_text						=>	"&nbsp;with daily drug doses of",
			  ...
			  :download_export_descr				=>	'.oddb.yaml.gz and oddb.yaml.zip contain the daily updated master data of ODDB.org. The master data is being exported by ywesee in the yaml-Format. The master data aims at software integration companies of insurances, hospitals, pharmacies, doctors, old folks homes etc. At this moment the master data is free. If you successfully apply our master data we will happily accept a fee from you.',
				...
				:en												=>	'English',
				:exam_header							=>	'Year of state-exam:',
				:exact_match							=>	'I only want to search by the exact drug name (once!).',
...
.',
				...
				:fachinfos_version_3_3_pdf	=>	'Doctor-Information-Version-3.3.pdf',
				:false										=>	'No',
				:faq_link									=>	'FAQ',
				:fax											=>	'Fax:',
				:fax_header								=>	'Fax',
				...
				:feedback_text_e					=>	"My expirience / My<br> opinion to <br> this drug is: <br> (max. 400 letters)",
				...
				:fi_charge0								=>	'<b>Doctor Information</b> &aacute; CHF&nbsp;',
				:fi_charge1								=>	'.-',
				:fi_composition						=>	'Composition.',
				:fi_contra_indications		=>	'Contra Indication',
				:fi_count_text						=>	'&nbsp;Doctor Information',
				...
				:fipi_activation_charge_value	=>	"CHF 1'500.-",
				:pi_count_text						=>	'&nbsp;Consumer informationen',
				...
				:fipi_offer_input_explanation1	=>	"<br>who will update the Information. Then click on 'Calculate Offer'.",
				:fr												=>	'Fran&ccedil;ais',
				:fons_header							=>	'Phone',
				:vcard										=>	'vCard',
=begin
...
=end
				...
				:generic									=>	'Generic',
				:generic_definition				=>	'What are generic drugs? <href="http://www.fda.gov/cder/ogd/">',
				:generic_definition_text1	=>	'Gem&auml;ss Artikel 14 Absatz 1 Buchstabe a des Heilmittelgesetzes (HMG; SR 812.21) kann das Schweizerische	Heilmittelinstitut (Swissmedic) f&uuml;r bestimmte Kategorien von Arzneimitteln vereinfachte Zulassungsverfahren vorsehen, insbesondere f&uuml;r Arzneimittel mit	bekannten Wirkstoffen. Dies betrifft in erster Linie die Generika. Damit jedoch ein Präparat den Status eines	Generikums f&uuml;r sich in Anspruch nehmen kann, muss	das Zulassungsgesuch eingereicht werden, solange das Originalpr&auml;parat noch &uuml;ber eine Zulassung verf&uuml;gt.',
				:generic_definition_text2	=>	'Im Gesetz wird der Begriff «Arzneimittel mit bekannten	Wirkstoffen» zwar nicht n&auml;her festgelegt, die Definition geht jedoch aus der Verordnung des Schweizerischen Heilmittelinstituts &uuml;ber die vereinfachte Zulassung und die Meldepflicht von Arzneimitteln (VAZV; SR 812.212.23) hervor. Die Auslegung zeigt, dass unter	einem Arzneimittel mit bekannten Wirkstoffen ein Medikament zu verstehen ist, dessen Wirkstoff in einem	zum betrachteten Zeitpunkt zugelassenen Originalpr&auml;parat	enthalten ist.',
				:generic_definition_text3	=>	'Der Begriff «bekannter Wirkstoff» wird im Abschnitt 2 dieser Verordnung verwendet, welche das vereinfachte	Zulassungsverfahren f&uuml;r Medikamente regelt, die	solche Wirkstoffe enthalten. Artikel 4 präzisiert, dass	ein Arzneimittel vereinfacht zugelassen werden kann, dessen Wirkstoff in einem vom Institut bereits zugelassenen Arzneimittel enthalten ist (bekannter Wirkstoff).',
				:generic_definition_text4	=>	'Der Begriff «bereits zugelassenes Arzneimittel» wird in Abschnitt 4 VAZV, Artikel 15, zu den Co-Marketing-Arzneimitteln wieder aufgenommen: Erf&auml;hrt das	Basispr&auml;parat &Auml;nderungen, so sind diese f&uuml;r das Co-Marketing-Arzneimittel gleichzeitig zur Zulassung	zu beantragen. Dies bedeutet, dass das Originalpr&auml;parat noch immer zugelassen sein muss.',
				...
				:home_user								=>  'Services-Home',
				:home_welcome							=>  'Welcome to ODDB.org the open drug database of Switzerland.<br>The data is being updated over the monthly publication of the<br><a class="welcome" href="http://www.bsv.admin.ch/sl/liste/d/index.htm" target="_blank">Swiss Federal Office of Public Health</a> and the <a class="welcome" href="http://www.swissmedic.ch/de/industrie/overall.asp?theme=0.00110.00001&amp;theme_id=980" target="_blank">Swissmedic-Journal</a>.',
				:home_welcome_doctors			=>	"Welcome to oddb.org the\nopen doctors database of Switzerland.\nThe data is being update directly over\n <a class='welcome' href='http://www.fmh.ch' target='_blank'>Swiss Medical Association</a>.",
				:html_title								=>	'ODDB.org: Open Drug Database',
				...
				:plugin_description				=>	'For Mozilla, Mozilla-Firefox and the Netscape Browser there is the practical Generika.cc Plugin, available for Download. With this Plugin you can search directly via the searchbar (Mozilla, Netscape) or the Quick-Search feature of Mozilla-Firefox:',
				...
				:plugin_download_gif			=>	'Generika.cc.gif',
				:plugin_download_src			=>	'oddb.cc.src',
				:plugin_javascript				=>	'Plugin Package-Download',
				:plz											=>	'Postal code',
				:point										=>	'.',
				:powerlink								=>	'Power-Link',
				...
				:print_type_fachinfo			=>	'Doctor information',
				:print_type_patinfo				=>	'Consumer Information',
				:producer									=>	'Manufacturer',
				:products									=>	'Brandname of Drug',
				:pub_med									=>	'PubMed',
				:pub_med_href							=>	'http://www.pubmedcentral.nih.gov',
				...
				:s31x_zip									=>	's31x.zip',
				:search										=>	'Search',
				:search_explain						=>	'Search for your drug fast and easy. Search by name of drug, active agent or indication.',
				:search_help							=>	'Help',
				:search_oddb							=>	'-> show drug(s) in ODDB',
				:search_query							=>	'Enter here drug or active agent',
				:search_reset							=>	'Reset',
				:search_sequences         =>  'Search',
				:select_substance_list		=>	'The active agent you have entered does not exist. Please choose another one or save the new active agent.',
				:select_substance_list_user	=>	'This active agent does not yet exist. Do you want to save this active agent?
',
				...
				:th_company_contact				=>	'Email',
				:th_company_name					=>	'Owner of registration',
				...
				:th_ikscat								=>	'Gategorie',
				:th_ikscat_title					=>	'Swissmediv Categorie / SL-Entry',
