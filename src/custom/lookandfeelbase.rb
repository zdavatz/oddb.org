...
',
        ...
        :fi_shorten_path          => 'Short URL',
				...
				:fi_upload_instruction2   =>	'2). Klicken Sie auf den Browse Button und w&auml;hlen Sie<br> die gew&uuml;nschte Word-Datei (doc/docx) aus.',
        ...
        :parts                    =>  'Teilpackungen',
				...
				:patinfo_all_title        =>  'Vollst&auml;ndige Patinformation',
        ...
        :prescription_type_original    =>  'Original aus medizinischen Gr&uuml;nden nicht substituierbar',
        ...
        :prescription_term_per_month   =>  'Dauerrezept G&uuml;ltigkeit in Monaten',
        ...
        :activate_patinfo         =>  'Activer l\'information patient (dd.mm.YYYY)',
				...
				:address_at_private				=>	'Adresse priv&eacute;e',
        ...
        :add_drug                 =>  'Inscrire ici le nom du médicament',
				:add_to_interaction				=>	'<span style="color:red;">Cliquez sur le r&eacute;sultat de recherche</span>, pour ajouter le produit souhait&eacute; &agrave; son panier d\'interaction.',
        ...
        :and                      =>  ' et ',
				...
				:assign_patinfo_explain1	=>  '" &agrave; d\'autres s&eacute;quences',
				:assign_other_patinfo			=>  'Confirmez une information liée au patient étendue &agrave; cette s&eacute;quence',
				:assign_this_patinfo			=>  'Confirmez cet effacement étendu &agrave; d\'autres s&eacute;quences',
        :assign_division           =>  'Vous confirmez que vous voulez couper ou effacer ces informations',
        :assign_division_equal     =>  'identique',
        :assign_division_explain0  =>  '  Attribuer, couper ou écraser s&eacute;quence "',
        :assign_division_explain1  =>  '" &agrave; autres s&eacute;quences',
        :assign_other_division     =>  'Attribuer couper ou écraser &agrave; cette s&eacute;quence',
        ...
        :commercial_forms         =>  'formes commercialisées',
				...
				:compare_desc1_no_atc1		=>	'"</b> veuillez envoyer un e-mail &agrave;:',
        ...
        :dosing_title             =>  "Wirkstoffliste Posologie lors d’insuffisance rénale - dosing.de",
				...
				:download_generics				=>	'Tous les médicaments et les Génériques correspondants dans un fichier d\'Excel, actualis&eacute; chaque mois!',
        ...
        :e_path_already_exist     =>  'existe déjà',
				...
				:e_subscriber_mail_notsent=>	"L'&Eacute;chec de l'envoi &agrave; l'e-mail indiqu&eacute;. Veuillez essayer &agrave; nouveau ou pr&eacute;parez-vous &agrave; un message d'erreur: zdavatz at ywesee dot com",
        ...
        :explain_auc_factor_125   =>  '<span class="auc-factor-125"> inhibition faible </span>: causant une montée > 1.25-fois des valeurs AUC de plasma ou une réduction en Clearance de 20-50%.',
				...
				:explain_feedback					=>	' =  Remarques et commentaires au sujet de ce m&eacute;dicament et de sa fiche',
				...
				:explain_google_search		=>	' = Recherche Google par nom de m&eacute;dicament',
				...
				:explain_narc_controlled	=>	'<a href="http://www.swissmedic.ch/index/index.html?action=id&id=35&lang=fr">Listes des substances contr&ocirc;l&eacute;es</a>',
        ...
        :fi_shorten_path          => 'Short URL',
				...
				:fi_upload_instruction1		=>	'1). S&eacute;lectionner d\abord la langue.',
        ...
        :hide_legend              =>  'cacher la légende',
				...
				:home_doctors							=>  'Accueil-M&eacute;decins',
				:home_hospitals					  =>	'Accueil-H&ocirc;pital',
        ...
        :market_date_preview      =>  'Produit en commerce dès',
				...
				:merge_companies1					=>	' s&eacute;qu&eacute;nces li&eacute;.<br>Choisissez une autre entreprise pour les s&eacute;qu&eacute;nces:',
				:merge_companies					=>	' mettre ensemble avec:',
				:merge_galenic_form0			=>	"Avec la forme gal&eacute;nique &agrave; supprimer sont encore ",
				:merge_galenic_form1			=>	' s&eacute;qu&eacute;nces li&eacute;.<br>Choisissez une autre forme gal&eacute;nique pour les s&eacute;qu&eacute;nces:',
				:merge_indication0				=>	"Avec la forme d'utilisation &agrave; supprimer sont encore ",
				:merge_indication1				=>	" enregistrements li&eacute;.<br>Choisissez une autre forme d'utilisation pour les enregistrements:",
        ...
        :parts                    =>  'Emballage partiel',
				...
				:paypal_e_expired0				=>	'',
				:paypal_e_expired1				=>	': la dur&eacute;e de validit&eacute; est expir&eacute;e (',
				:paypal_e_expired2				=>	')',
        ...
        :pi_date                  =>  'Mise &agrave; jour',
        :pi_galenic_form          =>  'Forme gal./Grpe.th.',
        :pi_unwanted_effects      =>  'Effets ind&eacute;sir.',
        :pi_effects               =>  'Propri&eacute;t&eacute;s',
        ...
        :pi_packages              =>  'Pr&eacute;sentations',
        ...
        :pi_distribution          =>  'Distrib.',
				...
				:poweruser_mail_instr1		=>	', d&eacute;clarez-vous par le lien ',
        ...
        :privileges               =>  'Privileges',
				...
				:query_limit1							=>	' interrogations par jour. Vous trouvez toujours les informations destin&eacute;es aux patients et aux professionnels. Utilisez la fonction de recherche en haut &agrave; droite.',
				...
				:query_limit_login				=>	'B) Si vous &ecirc;tes d&eacute;j&agrave; abonn&eacute, veuillez fournir votre e-mail et votre mot de passe pour arriver &agrave; l\avis de votre choix:',
				...
				:query_limit_poweruser_a1 =>	'</b>. Avec cette abonnement vous pouvez utiliser ODDB.org int&eacute;gralement. Le tarif est pour un utilisateur unique.',
				...
				:query_limit_poweruser_c1 =>	'</b> par <b>24 heures</b>. Le tarif indiqu&eacute; est pour un utilisateur unique.',
        ...
        :prescription_format_paper     =>  'Papier',
        :prescription_format_shipping  =>  'Versand (der Patient w&uuml;nscht Bezug &uuml;ber MediService.)',
        :prescription_notes            =>  'Aucune information ne sera sauvegard&eacute;e par ch.oddb.org plus longtemps que n&eacute;cessaire pour l\'impression. Cependant vous pouvez t&eacute;l&eacute;charger et sauvegarder localement les donn&eacute;es sous forme d\'un fichier CSV.',
