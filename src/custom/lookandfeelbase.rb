...
',
        ...
        :e_invalid_fachinfo_id1   =>  '"',
				...
				:email_text_good_migel		=>	"Je suis d'accord pour échanger mon expérience de ce position de LiMA avec d'autres utilisateurs. Mon adresse e-mail peut être divulguée.",
        ...
        :feedback_feed_title      =>  'Feedback par patients et docteurs pour produits santé',
				...
				:feedback_text_a_good_migel	=>	"J'ai une expérience positive de ce position de LiMA.",
