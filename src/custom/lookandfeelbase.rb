...
=end
				...
				:release_ouwerkerk_confirm=>	'Der Export wurde ausgel&ouml;st.',
				:result										=>	'Suchresultat',
			...
			'fr'			=>		{
				...
				:anthroposophy						=>	'M&eacute;dicaments anthroposophiques',
				...
				:email										=>	'&Eacute;mail ',
				:email_text_good					=>	"Je suis pri&ecirc;t d'&eacute;chang&eacute;es avec d'autres personnes mes exp&eacute;riences concernant ce m&eacute;dicament. Mon Mail-Adresse ne doit pas rester anonyme.",
				...
				:explain_a								=>	'M&eacute;dicaments anthroposophiques',
				...
				:explain_h								=>	'M&eacute;dicaments hom&eacute;opathiques',
				:explain_li								=>	'L = Limitations',
				:explain_original					=>	'rouge&nbsp;=&nbsp;original',
				:explain_pbp							=>	'PP = Prix de public, TVA comp.',
				:explain_p								=>	'P = M&eacute;dicaments phytoth&eacute;rapeutiques',
				...
				:phytotherapy							=>	'M&eacute;dicaments phytoth&eacute;rapeutiques',
