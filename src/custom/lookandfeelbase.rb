...
=end
			...
			'fr'			=>		{
				...
				:download_export_descr				=>	"Plus d'information sur les donn̩es de base d'ODDB.or",
				...
				:en												=>	'English',
				:exact_match							=>	'Je veux chercher conform&eacute;ment au nom de &eacute;dicament ou fabricant (une fois!).',
