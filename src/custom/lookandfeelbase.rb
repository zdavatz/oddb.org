...
=end
			...
			'fr'			=>		{
				...
				:drugs										=>	'Médicaments',
				:download_export_descr				=>	"oddb.yaml.gz et oddb.yaml.zip contiennent les donn&eacute;es de base d'articles des ODDB. Ils sont mises &agrave; jour tous les jours. Ywesee converte les donn&eacute;es en YAML-Format et les mette &agrave; la disposition pour tout le fournisseur de systèmes des les hôpitaux suisses.",
				...
				:explain_fi								=>	'IPro = Information destinée aux professionnels',
				...
				:explain_pi								=>	'IPat = Information destinée aux patients',
				...
				:fi_count_text						=>	'&nbsp;Informations destinées aux professionnels',
				...
				:fipi_offer_input_explanation0	=>	"Veuillez enregistrer vers le le nombre des informations destinées aux professionnels, le nombre des informations destinées aux patients et décidez vous si la mise à jour doit mettre par",
				:fipi_offer_input_explanation1	=>	"<br>ou par vous-même. Cliquetez sur 'Calculez Offre'.",
				...
				:patinfo_column						=>	'Informations destinées aux patients.',
				...
				:pi_count_text						=>	'&nbsp;Informations destinées aux patients',
				:pi_quantity0							=>	'Nombre des', 
				:pi_quantity2							=>	'.- / IPat par annéé)',
				:plugin										=>	'Plugin',
				:plugin_generika					=>	'Generika.cc - Plugin',
