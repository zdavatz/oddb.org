...
=end
				...
				:home_welcome							=>  "Willkommen bei oddb.org, dem<br>aktuellsten Medikamenten-Portal der Schweiz.<br>Die Daten werden monatlich aktualisiert. <a class='welcome' href='http://wiki.oddb.org/wiki.php?pagename=Swissmedic.Datendeklaration'>Herkunftsdeklaration</a>",
...
=end
				...
				:home_user								=>  'Services-Home',
				:home_welcome							=>  "Welcome to oddb.org<br>the open drug database of Switzerland.<br>The data are updated on a monthly basis. <a class='welcome' href='http://wiki.oddb.org/wiki.php?pagename=Swissmedic.Datendeklaration'>Declaration of origin</a>",
