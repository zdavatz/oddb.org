		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:fachinfo_descr0					=>	'Fachinformationen zu ',
				:fachinfo_descr1					=>	'',
				...
				:st_migel									=>  'Mittel und Gegenstandsliste',
			...
			'fr'			=>		{
				...
				:query_limit_explain2			=>	" demandes dans une journée. Nous avons les propositions suivants, pour faire valoir vos droits encore plus.<br>La vue des informations destin&eacute;es aux professionels et les informations destin&eacute;es aux patients est encore possible pour les informations qui sont publiée sur ODDB.org. Utilisez la champ d'affichage au-dessus.<br>Si vous ne voulez pas des restrictions sur les transmissions vous pouvez utiliser les sites suivantes: <a href=\"http://www.atupri.ch\">www.atupri.ch</a> et <a href=\"http://www.provita.ch\">www.porvita.ch</a>",
