...
',
        ...
        :and                      =>  ' et ',
				...
				:assign_patinfo_explain0	=>  'Validez l\'information liée au patient pour la s&eacute;quence "',
        ...
        :ddd_price_comparison     =>  'Compraison des coûts journaliers',
				...
				:de												=>	'Deutsch',
        :deactivate_fachinfo      =>  'Déactiver information professionnelle (dd.mm.YYYY)',
        ...
        :division_source          =>  'Quellen',
				...
				:doctors_search_explain	  =>	'Cherchez par m&eacute;decin en Suisse. Vous pouvez chercher conform&eacute;ment au nom,<br> adresse, t&eacute;l&eacute;phone ou &agrave; titre de m&eacute;decin sp&eacute;cialiste.',
				:dose											=>	'Concentration',
        ...
        :e_path_already_exist     =>  'existe déjà',
				:e_fi_not_parsed0				=>	'Le Word ne pouvait pas être traité et sera anlysé par un administrateur. ',
				:e_fi_not_parsed1				=>	'',
        ...
        :explain_auc_factor_125   =>  '<span class="auc-factor-125"> inhibition faible </span>: causant une montée > 1.25-fois des valeurs AUC de plasma ou une réduction en Clearance de 20-50%.',
				...
				:fachinfo_descr1					=>	'',
        :fachinfo_feed_description=>  'Informations professionnelles nouveaux et modifiées au marche de santé suisse.',
        ...
        :pi_general_advice        =>  'Général conseils',
        :pi_purpose               =>  'But',
        ...
        :privileges               =>  'Privileges',
				...
				:query_limit_new_user			=>	'A) Si vous n\&ecirc;tes pas encore registr&eacute; comme utilisateur, veuillez lire le message qui suit: ',
