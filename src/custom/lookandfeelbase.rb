...
',
        ...
        :activate_patinfo         =>  'Activer l\'information patient (dd.mm.YYYY)',
				...
				:address									=>	'Rue',
				:address_at_praxis				=>	'Adresse cabinet médical',
        ...
        :assign_this_division      =>  'Attribuer cette couper ou écrase à autres séquences',
        ...
        :division_source          =>  'Quellen',
				...
				:doctors									=>  'Médecin',
				:doctors_search_explain	  =>	'Cherchez par médecin en Suisse. Vous pouvez chercher conformément au nom,<br> adresse, téléphone ou à titre de médecin spécialiste.',
				:dose											=>	'Concentration',
        ...
        :explain_auc_factor_125   =>  '<span class="auc-factor-125"> inhibition faible </span>: causant une montée > 1.25-fois des valeurs AUC de plasma ou une réduction en Clearance de 20-50%.',
				...
				:explain_complementary_url =>	'http://www.svkh.ch',
				:explain_ddd_price				=>	'CTJ = Co&ucirc;t de traitement journalier',
				:explain_ddd_price_url		=>	'http://wiki.oddb.org/wiki.php/ODDB/Tageskosten',
        ...
        :home_welcome_hospitals   =>  'Bienvenue parmi les hôpitaux suisses !',
				:hors_commerce						=>	'h.c.',
				:hospital_count_text			=>	'Hôpital',
				:hospitallist							=>	'Hôpitals',
				:hospitals								=>	'Hôpital',
        ...
        :market_date_preview      =>  'Produit en commerce dès',
				...
				:merge_companies1					=>	' séquénces lié.<br>Choisissez une autre entreprise pour les séquénces:',
				:merge_companies					=>	' mettre ensemble avec:',
				:merge_galenic_form0			=>	"Avec la forme galénique à supprimer sont encore ",
				:merge_galenic_form1			=>	' séquénces lié.<br>Choisissez une autre forme galénique pour les séquénces:',
        ...
        :parts                    =>  'Emballage partiel',
				...
				:patinfos									=>	'Informations destinées aux patient',
        ...
        :privileges               =>  'Privileges',
				...
				:query_limit_poweruser_b1 =>	' demandes par jour et vous voulez tester le Produit ODDB.org pour un mois ? &Ccedil;a fait <b>', 
