...
',
        ...
        :i_patinfo_assigned       =>  'L\'information patient a été assignée.',
				...
				:i_subscriber_mail_sent		=>	"Votre annonce a été envoyée. Si vous n'obtenez pas d'émail dans les prochaines minutes, veuillez vérifier vos données et essayer de nouveau l'adresse d'émail indiquée.",
				:i_unsubscriber_mail_sent	=>	"Votre déclaration de départ a été envoyée. Si vous n'obtenez pas d'émail dans les prochaines minutes, veuillez vérifier vos données et essayer de nouveau l'adresse d'émail indiquée.",
