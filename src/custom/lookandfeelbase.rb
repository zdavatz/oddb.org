  ...
  class LookandfeelBase < SBSM::Lookandfeel
    ...
    DICTIONARIES = {
      "de" => {
        ...
        :doctors => "Arzt",
        :doctors_search_explain => "Suchen Sie nach Arzt oder Ärztin in der Schweiz. Sie können nach Name, Adresse, Telefon oder Facharzttitel suchen.",
        :dose => "Stärke",
        ...
        :download_android_app => "Android Generika App",
        ...
        :drugshortage_label => "Verfügbarkeit",
        ...
        :e_empty_result => "Ihr Such-Stichwort hat zu keinem Suchergebnis geführt. Bitte überprüfen Sie die Schreibweise und versuchen Sie es noch einmal.",
        :e_exception0 => 'System-Fehler: "',
        :e_exception1 => '"',
        :e_empty_migel_result => "Suchen Sie in der Liste von den Krankenversicherern im Rahmen der obligatorischen Krankenpflegeversicherung als Pflichtleistung zu vergütenden Mittel und Gegenstände.",
        ...
        :e_corrupted_index => "Der Suchindex ist beschädigt. Bitte führen Sie aus: bundle exec ruby jobs/rebuild_indices",
        ...
        :explain_narc_url => "https://www.swissmedic.ch/dam/swissmedic/de/dokumente/internetlisten/zugelassene_btm_ham.xlsx.download.xlsx/BTM%20HAM.xlsx",
        ...
        :explain_search => "Sie können nach Originalpräparat, Generikum, Wirkstoff oder Hersteller suchen. Die Suche erfolgt nach dem ATC-Code.",
        ...
        :fachinfo_create => "FI?",
        :fachinfo_descr0 => "FI zu ", # goes into the heading
        :fachinfo_descr1 => "",
        ...
        :feedback_title2 => "",
        :rss_html_date => "Datum",
        :rss_html_title => "Titel",
        :rss_html_iksnr => "Swissmedic-Nr.",
        :rss_html_newest => "Neueste",
        :rss_html_entries => "Einträge",
        :rss_html_source => "Diese Seite als RSS-Feed abonnieren",
        :rss_html_empty => "Zurzeit keine Einträge.",
        :rss_html_link => "als Seite lesen",
        :feedback_rss_title0 => "",
        ...
        :interaction_chooser_description => "Werden keine Interaktionen angezeigt, sind z.Z. keine Interaktionen bekannt. Interaktionen zur Verfügung gestellt durch ",
        :epha_public_domain => "SDIF - Swiss Drug Interactions Finder",
        ...
        :swiyu_login_link => "<ol><li><a href='/swiyu'>Bitte melden Sie sich mit Ihrer Swiyu Wallet an</a>, um ODDB.org uneingeschr&auml;nkt zu nutzen.</li><li>Bei Fragen: <a href='mailto:zdavatz at ywesee dot com'>zdavatz at ywesee dot com</a></li><li>Die Swiyu-App f&uuml;r <a href='https://apps.apple.com/ch/app/swiyu/id6737259614' target='_blank'>iOS</a> k&ouml;nnen Sie hier runterladen.</li><li>Die Swiyu-App f&uuml;r <a href='https://play.google.com/store/apps/details?id=ch.admin.foitt.swiyu&amp;hl=de_CH' target='_blank'>Android</a> k&ouml;nnen Sie hier runterladen.</li><li><b>Ihr Swiyu ywesee Zertifikat k&ouml;nnen Sie <a href='https://forms.gle/BNZE4qTvHV8Go7tP6' target='_blank'>hier beantragen</a>.</b></li></ol>",
        ...
        :migel_search_explain => "Suchen Sie in der Liste von den Krankenversicherern im Rahmen der obligatorischen Krankenpflegeversicherung als Pflichtleistung zu vergütenden Mittel und Gegenstände.",
        ...
        :fachinfo_changes_title => "Fachinfo-Änderungen",
        :patinfo_changes_title => "Patinfo-Änderungen",
        ...
        :th_bag_substances => "BAG: Wirkstoffe",
      ...
      "fr" => {
        ...
        doctors: "Médecin",
        doctors_search_explain: "Cherchez par médecin en Suisse. Vous pouvez chercher selon le nom, l'adresse, le numéro de téléphone ou le titre de médecin spécialiste.",
        dose: "Concentration",
        ...
        drugshortage: "Drugshortage Info",
        drugshortage_label: "Disponibilité",
        ...
        e_empty_result: "Votre mot clé de recherche n'a abouti à aucun résultat. Veuillez contrôler l'orthographe et essayez encore une fois.",
        ...
        e_corrupted_index: "L'index de recherche est corrompu. Veuillez exécuter: bundle exec ruby jobs/rebuild_indices",
        e_invalid_atc_class0: '"',
        ...
        feedback_title2: "",
        rss_html_date: "Date",
        rss_html_title: "Titre",
        rss_html_iksnr: "No Swissmedic",
        rss_html_newest: "Les plus récentes",
        rss_html_entries: "Entrées",
        rss_html_source: "S'abonner à cette page comme flux RSS",
        rss_html_empty: "Aucune entrée pour le moment.",
        rss_html_link: "lire comme page",
        feedback_rss_title0: "",
        ...
        interaction_chooser_description: "Aucune interaction est affiché si à présent aucune est connue. Les données pour les interactions sont fournies par ",
        epha_public_domain: "SDIF - Swiss Drug Interactions Finder",
        ...
        swiyu_login: "Identification",
        swiyu_login_link: "<ol><li><a href='/swiyu'>Veuillez vous connecter avec votre Swiyu Wallet</a> pour utiliser ODDB.org sans restriction.</li><li>Questions: <a href='mailto:zdavatz at ywesee dot com'>zdavatz at ywesee dot com</a></li><li>T&eacute;l&eacute;chargez l'application Swiyu pour <a href='https://apps.apple.com/ch/app/swiyu/id6737259614' target='_blank'>iOS</a> ici.</li><li>T&eacute;l&eacute;chargez l'application Swiyu pour <a href='https://play.google.com/store/apps/details?id=ch.admin.foitt.swiyu&amp;hl=de_CH' target='_blank'>Android</a> ici.</li><li><b>Vous pouvez <a href='https://forms.gle/BNZE4qTvHV8Go7tP6' target='_blank'>demander ici</a> votre certificat Swiyu ywesee.</b></li></ol>",
        swiyu_logout: "Logout",
        logo_file: "Logo",
        logo: SERVER_NAME,
        logout: "Logout",
        ...
        migel_search_explain: "Cherchez dans la liste des moyens et appareillages pris en charge dans le cadre de l'assurance obligatoire des soins par les assureurs-maladie.",
        ...
        fachinfo_changes_title: "Modifications de l'info professionnelle",
        patinfo_changes_title: "Modifications de l'info patient",
        ...
        th_bag_substances: "BAG: Principe actif",
        th_tel: "Téléphone",
        title: "Titre",
      ...
      "en" => {
        ...
        doctors: "Doctor",
        doctors_search_explain: "Search for a doctor in Switzerland. Search by name, address, telefon, professional title or a combination of these.",
        dose: "Concentration",
        ...
        drugshortage: "Drugshortage Info",
        drugshortage_label: "Disponibility",
        direct_link: "Direct-Link",
        ean13: "EAN",
        ean13_header: "EAN:",
        ean_code0: "GTIN: ",
        ...
        e_empty_result: "Your search string does not produce any search result. Please check the spelling and try again.",
        ...
        e_corrupted_index: "The search index is corrupted. Please run: bundle exec ruby jobs/rebuild_indices",
        e_invalid_atc_class0: '"',
        ...
        e_invalid_ean_code0: '"',
        e_invalid_ean_code1: '" is not a valid GTIN. Please verify.',
        e_invalid_email_address0: '"',
        ...
        feedback_title2: "",
        rss_html_date: "Date",
        rss_html_title: "Title",
        rss_html_iksnr: "Swissmedic no.",
        rss_html_newest: "Latest",
        rss_html_entries: "Entries",
        rss_html_source: "Subscribe to this page as an RSS feed",
        rss_html_empty: "No entries at the moment.",
        rss_html_link: "read as page",
        feedback_rss_title0: "",
        ...
        interaction_chooser_description: "If no interactions are known at the present, none are shown. Interactions are provided by ",
        epha_public_domain: "SDIF - Swiss Drug Interactions Finder",
        interactions: "Interactions",
        ...
        swiyu_login: "Login",
        swiyu_login_link: "<ol><li><a href='/swiyu'>Please log in with your Swiyu Wallet</a> to use ODDB.org without restrictions.</li><li>Questions: <a href='mailto:zdavatz at ywesee dot com'>zdavatz at ywesee dot com</a></li><li>Download the Swiyu app for <a href='https://apps.apple.com/ch/app/swiyu/id6737259614' target='_blank'>iOS</a> here.</li><li>Download the Swiyu app for <a href='https://play.google.com/store/apps/details?id=ch.admin.foitt.swiyu&amp;hl=de_CH' target='_blank'>Android</a> here.</li><li><b>You can <a href='https://forms.gle/BNZE4qTvHV8Go7tP6' target='_blank'>request here</a> your Swiyu ywesee certificate.</b></li></ol>",
        swiyu_logout: "Logout",
        logo_file: "Logo",
        logo: SERVER_NAME,
        logout: "Logout",
        ...
        fachinfo_changes_title: "Professional information changes",
        patinfo_changes_title: "Patient information changes",
        ...
        th_bag_substances: "BAG: Active Agent",
        th_tel: "Phone",
        time_format: "%A, %d. %B %Y",
        time_format_long: "%A, %d. %B %Y, %H:%M:%S",
        title: "Title",
