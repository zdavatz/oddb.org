		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:hospitals								=>	'Spital',
				:hosting_invoice_date			=>	'Rechnungsversand Hosting',
				...
				:index_invoice_date				=>	'Rechnungsversand Firmenverzeichnis',
				...
				:logo											=>	'oddb.org',
				:logout										=>	'Abmelden',
				:lookandfeel_invoice_date	=>	'Rechnungsversand Lookandfeel',
				...
				:pref_invoice_date				=>	'Rechnungsversand PI-Upload',
