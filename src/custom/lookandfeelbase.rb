...
',
				...
				:password_lost_subject		=>	'Passwort vergessen',
				:password_lost_body0			=>	"Um Ihr Passwort neu zu setzen, klicken Sie bitte auf den folgenden Link:\n",
				:password_lost_body1			=>	"\n\nDieser Link ist bis ",
				:password_lost_body2			=>	" Uhr gültig.\n\nMit freundlichen Grüssen\nIhr oddb.org-Team.",
			...
			'fr'			=>		{
				...
				:explain_password_lost		=>	'Entrez votre addresse E-Mail s.v.p. Nous vous envoierons un Email avec un lien. Appuyez le lien et entrez de votre nouveau mot de passe.',
				...
				:password_lost_subject		=>	'Mot de passe oubli&eacute;',
				:password_lost_body0			=>	"Pour remettre votre mot de passe, veuillez cliquer sur le lien suivant:\n",
				:password_lost_body1			=>	"\n\nCe lien est valide jus'qu &agrave; ",
			...
			'en'			=>		{
			  ...
			  :download_export_descr		=>	'More Information regarding the Master Data',
				...
				:password_lost_subject		=>	'Lost password',
				:password_lost_body0			=>	"Please click on the following link to set a new password:\n",
