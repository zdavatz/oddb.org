...
=end
			...
			'fr'			=>		{
				...
				:legal_note_doctors_text1	=>	'Des adresses m&eacute;dicales doivent &ecirc;tre publi&eacute;es conform&eacute;nt au gouvernail de direction <a href="http://www.admin.ch/ch/f/sr/811_113/a10.html">SR 811.113</a> (r&egrave;lement sur le perfectionnement et la reconnaissance des dipl&ocirc;mes et titre de perfectionnement des professions m&eacute;dicales) par le FMH. ywesee offre les donn&eacute;es brutes dans le CSV-Format et font remarquer en rapport avec une protection des donn&eacute;es et publicit&eacute; ind&eacute;sirable (Spam) ce qui suit: ',
				:legal_note_doctors_text2	=>	"a) Des adresses m&eacute;dicales sont d'int&eacute;r&ecirc;t public, cela valent toutefois que pour des adresses d'h&ocirc;pital et pratiques, pas pur les adresses priv&eacute;es. ",
				:legal_note_doctors_text3	=>	"b) Le FMH publie les adresses de tous les M&eacute;decins Suisses dans Internet. Nous consid&eacute;rons qu'il s'agit exclusivement avec cela de donn&eacute;es publiquement pertinentes. Par le FMH aucune adresse de Email priv&eacute;e n'est publi&eacute;e. ",
				:legal_note_doctors_text4	=>	"c) Si votre adresse de logement ou Email priv&eacute;e est publi&eacute;e par le FMH, nous recommandons vous vous adressez directement au FMH. Nous sommes volontiers aussi pr&ecirc;ts &agrave; entreprendre directement des corrections correspondantes dans nos donn&eacute;es.\nContact: zdavatz at ywesee dot com.", 
				:limitation								=>	'Limitation',
