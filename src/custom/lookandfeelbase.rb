...
',
        ...
        :prescription_quantity_morning =>  'Morgens',
        :prescription_quantity_noon    =>  'Mittags',
        :prescription_quantity_evening =>  'Abends',
        :prescription_quantity_night   =>  'Nachts',
        :prescription_method_as_necessary => 'Nach Bedarf',
        :prescription_method_regulaly     => 'Nach Vorschrift',
        ...
        :prescription_timing_before_meal => 'vor dem Essen',
        :prescription_timing_with_meal   => 'mit dem Essen',
        :prescription_timing_after_meal  => 'nach dem Essen',
        :prescription_term_once        =>  'Einmaliges Rezept',
        :prescription_term_repetition  =>  'Dauerrezept Wiederholungen',
        :prescription_term_per_month   =>  'Dauerrezept Gültigkeit in Monaten',
        ...
        :fi_shorten_path          => 'Short URL',
				...
				:finding									=>	'Résultat',
        :flockhart_link           =>  'Publications recommandées par le Dr Flockhart:',
        ...
        :prescription_sex_m            =>  'm',
        :prescription_quantity_morning =>  'Matin',
        :prescription_quantity_noon    =>  'Midi',
        :prescription_quantity_evening =>  'Soir',
        :prescription_quantity_night   =>  'Coucher',
        :prescription_method_as_necessary => 'à la demande',
        :prescription_method_regulaly     => 'strictement selon la prescription',
        ...
        :prescription_timing_before_meal => 'avant le repas',
        :prescription_timing_with_meal   => 'au cours du repas',
        :prescription_timing_after_meal  => 'après le repas',
        :prescription_term_once        =>  'prescription à n\'appliquer qu\'une seule fois',
        :prescription_term_repetition  =>  'Renouvellement de la prescription',
        :prescription_term_per_month   =>  'Durée de validité de la prescription en mois',
        :prescription_non_dispensation =>  'dieses Medikament noch nicht zustellen (non disp)',
        :prescription_format_paper     =>  'Papier',
