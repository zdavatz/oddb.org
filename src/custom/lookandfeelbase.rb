		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:explain_hors_commerce		=>	'a.H. = ausser Handel, d.h. nicht in <a href="http://www.medwin.ch">medwin.ch</a> aufgelistet',
			...
			'fr'			=>		{
				...
				:explain_hors_commerce		=>	'h.c = hors commerce, ne pas list&eacute; &agrave; <a href="http://www.medwin.ch">medwin.ch</a>',
			...
			'en'			=>		{
			  ...
			  :download_export_descr		=>	'More Information regarding the Master Data',
				...
				:explain_hors_commerce		=>	'n.t. = not traded, i.e. not listed on <a href="http://www.medwin.ch">medwin.ch</a>',
				:explain_li								=>	'L = Limitations',
