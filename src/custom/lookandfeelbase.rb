		...
		DICTIONARIES = {
			'de'			=>		{
			  ...
			  :download_export_descr		=>	'Mehr Infos zu den Stammdaten von ODDB.org',
				...
				:narcotic_connection0			=>	'Medikamente welche ',
				:narcotic_connection1			=>	'&nbsp;beinhalten.',
			...
			'fr'			=>		{
				...
				:choice										=>  'Editer',
				:choose_fachinfo_range		=>  'Veuillez choisir la gamme d&eacute;sir&eacute; des informations destin&eacute;es aux professionnels.',
				:choose_limittext_range		=>  'Veuillez choisir la gamme d&eacute;sir&eacute; des limitations.',
				:choose_patinfo_range			=>  'Veuillez choisir la gamme d&eacute;sir&eacute; des informations destin&eacute;es aux patients',
