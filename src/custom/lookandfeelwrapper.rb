  ...
  class LookandfeelEvidentia < SBSM::LookandfeelWrapper
    ...
    DICTIONARIES = {
      'de'  =>  {
        ...
        :fachinfo_all_icon        =>  'evidentia/Vollständige Fachinformation.png',
        ...
        :fachinfo_driving_ability_icon  => 'evidentia/Fahrtüchtigkeit.png',
        :fachinfo_unwanted_effects_icon  => 'evidentia/Unerwünschte Wirkungen.png',
        :fachinfo_overdose_icon       => 'evidentia/Überdosierung.png',
        :fachinfo_effects_icon        => 'evidentia/Eigenschaften.png',
        :fachinfo_kinetic_icon        => 'evidentia/Pharmakokinetik.png',
        :fachinfo_preclinic_icon      => 'evidentia/Präklinische Daten.png',
        :fachinfo_photo_icon          => 'evidentia/Foto.png',
        :fachinfo_composition_icon    => 'evidentia/Zusammensetzung.png',
        :fachinfo_galenic_form_icon   => 'evidentia/Galenische Form.png',
        :fachinfo_other_advice_icon   => 'evidentia/Sonstige Hinweise.png',
        ...
        :fachinfo_date_icon           => 'evidentia/Stand der Information.png',
