#!/usr/bin/env ruby
# View::Drugs::IncompleteRegistrations -- oddb -- 19.06.2003 -- hwyss@ywesee.com 
...
class IncompleteRegList < HtmlGrid::Composite
	COMPONENTS = {
		[0,0]	=>	View::Drugs::InnerIncompleteRegList,
		[0,1]	=>	View::Drugs::BsvForm,
...
class IncompleteRegistrations < View::PrivateTemplate
	CONTENT = View::Drugs::IncompleteRegList
