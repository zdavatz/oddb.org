#!/usr/bin/env ruby
# View::Drugs::OrphanedPatinfoAssign -- oddb -- 26.11.2003 -- rwaltert@ywesee.com
...
class OrphanedPatinfoAssignComposite < HtmlGrid::Composite
	...
	COMPONENTS = {
		[0,1] => :languages,
		[0,2] => View::Drugs::SearchFieldPatinfo,
		[0,3] => :sequences
	}
	CSS_MAP = {
		[0,0] => 'th',
	...
	def sequences(model, session)
		View::Drugs::OrphanedPatinfoSequences.new(@model.sequences, session, self)
	end
...
class OrphanedPatinfoAssign < View::PrivateTemplate
	CONTENT = View::Drugs::OrphanedPatinfoAssignComposite
