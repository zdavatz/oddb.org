#!/usr/bin/env ruby
# View::Drugs::OrphanedFachinfoAssign -- oddb -- 11.12.2003 -- rwaltert@ywesee.com
...
class OrphanedFachinfoAssignComposite < HtmlGrid::Composite
	...
	COMPONENTS = {
		[0,1] => :languages,
		[0,2] => View::Drugs::OrphanedDelete,
		[0,3] => View::Drugs::SearchFieldFachinfo,
		[0,4] => :registrations
	}
	CSS_MAP = {
		[0,0] => 'th',
	...
	def registrations(model, session)
		View::Drugs::OrphanedFachinfoRegistrations.new(@model.registrations, session, self)
	end
...
class OrphanedFachinfoAssign< View::PrivateTemplate
	CONTENT = View::Drugs::OrphanedFachinfoAssignComposite
