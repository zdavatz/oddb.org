#!/usr/bin/env ruby
# View::Drugs::Package -- oddb -- 14.03.2003 -- hwyss@ywesee.com 
...
class RootPackageComposite < View::Drugs::PackageComposite
	COMPONENTS = {
		[0,0]	=>	:package_name,
		[0,1]	=>	View::Drugs::PackageForm,
		[0,2]	=>	'th_source',
		[0,3]	=>	:source,
	}
	CSS_MAP = {
...
class RootPackage < View::Drugs::Package
	CONTENT = View::Drugs::RootPackageComposite
end
		end
	end
end
