#!/usr/bin/env ruby
# View::Drugs::ActiveAgent -- oddb -- 22.04.2003 -- hwyss@ywesee.com 
...
class ActiveAgentComposite < HtmlGrid::Composite
	COMPONENTS = {
		[0,0]	=>	:agent_name,
		[0,1]	=>	View::Drugs::ActiveAgentInnerComposite,
	}
	CSS_CLASS = 'composite'
	CSS_MAP = {
		[0,0]	=>	'th',
...
class RootActiveAgentComposite < View::Drugs::ActiveAgentComposite
	COMPONENTS = {
		[0,0]	=>	:agent_name,
...
class ActiveAgent < View::PrivateTemplate
	CONTENT = View::Drugs::ActiveAgentComposite
	SNAPBACK_EVENT = :result
end
class RootActiveAgent < View::Drugs::ActiveAgent
	CONTENT = View::Drugs::RootActiveAgentComposite
end
		end
	end
end
