#!/usr/bin/env ruby
# View::Drugs::SelectSubstance -- oddb -- 28.04.2003 -- benfay@ywesee.com
...
class SelectSubstanceComposite < HtmlGrid::Composite
	COMPONENTS = {
		...
		[0,2]	=>	View::Drugs::SelectSubstanceForm,
	...
	def assigned_list(model, session)
		View::Drugs::AssignedList.new(model.assigned, session, self)	
	end
end	
class SelectSubstance < View::PrivateTemplate
	CONTENT = View::Drugs::SelectSubstanceComposite
