#!/usr/bin/env ruby
# View::Drugs::GalenicGroup -- oddb -- 26.03.2003 -- andy@jetnet.ch
...
class GalenicGroupComposite < HtmlGrid::Composite
	...
	def galenic_forms(model, session)
		...
		View::Drugs::GalenicForms.new(mdl, session, self) unless model.is_a?(Persistence::CreateItem)
	end
end
class GalenicGroup < View::PrivateTemplate
	CONTENT = View::Drugs::GalenicGroupComposite
