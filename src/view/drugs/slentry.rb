#!/usr/bin/env ruby
# View::Drugs::SlEntry -- oddb -- 22.04.2003 -- benfay@ywesee.com
...
class SlEntryComposite < HtmlGrid::Composite
	COMPONENTS = {
		[0,0]	=>	:package_name,
		[0,1]	=>	View::Drugs::SlEntryInnerComposite,
	}
	CSS_CLASS = 'composite'
	CSS_MAP = {
		[0,0]	=>	'th',
...
class RootSlEntryComposite < View::Drugs::SlEntryComposite
	COMPONENTS = {
		[0,0]	=>	:package_name,
		[0,1]	=>	View::Drugs::SlEntryForm,
	}
end
class SlEntry < View::PrivateTemplate
	CONTENT = View::Drugs::SlEntryComposite
	SNAPBACK_EVENT = :result
end
class RootSlEntry < View::Drugs::SlEntry
	CONTENT = View::Drugs::RootSlEntryComposite
end
		end
	end
end
