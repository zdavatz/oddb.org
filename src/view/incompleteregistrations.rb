#!/usr/bin/env ruby
# IncompleteRegistrations -- oddb -- 19.06.2003 -- hwyss@ywesee.com 
...
=end
	...
	class IncompleteRegistrations < PrivateTemplate
		CONTENT = IncompleteRegList
