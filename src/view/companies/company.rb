...
class AjaxPharmaCompanyForm < AjaxCompanyForm
	COMPONENTS = {
		...
		[0,4]		=>	:disable_autoinvoice,
		[2,4]		=>	:pref_invoice_date,
		[0,5]		=>	:invoice_htmlinfos,
		[2,5]		=>	:patinfo_price,
		[2,6]		=>	:index_invoice_date,
		[0,7]		=>	:index_price,
		[2,7]		=>	:index_package_price,
		[0,8]		=>	:address,
		[0,9]		=>	:plz,
		[2,9]		=>	:city,
		[0,10]		=>	:fon,
		...
		[2,14]	=>	:ean13,
		[0,15]	=>	:cl_status,
		[2,15]	=>	:registration_count,
		[0,16]	=>	:generic_type,
		[2,16]	=>	:complementary_type,
		[1,17]	=>	:patinfo_stats,
		[1,18]	=>	:submit,
		[1,18,0]=>	:delete_item,
	}
