...
class AjaxPharmaCompanyForm < AjaxCompanyForm
	COMPONENTS = {
		...
		[0,3]		=>	:contact,
		[2,3]		=>	:contact_email,
		[2,4]		=>	:regulatory_email,
		[0,5]		=>	:swissmedic_salutation,
		[2,5]		=>	:swissmedic_email,
		[0,6]		=>	:limit_invoice_duration,
		[2,6]		=>	:competition_email,
		[0,7]		=>	:disable_patinfo,
		[2,7]		=>	:invoice_date_patinfo,
		[0,8]		=>	:disable_invoice_patinfo,
		[2,8]		=>	:price_patinfo,
		[0,9]		=>	:invoice_htmlinfos,
		[2,9]		=>	:invoice_date_fachinfo,
		[0,10]		=>	:disable_invoice_fachinfo,
		[2,10]	  =>	:price_fachinfo,
		[2,11]	=>	:invoice_date_index,
		[0,12]	=>	:price_index,
		[2,12]	=>	:price_index_package,
		[0,13]	=>	:address,
		[0,14]	=>	:plz,
		[2,14]	=>	:city,
		[0,15]	=>	:fon,
		...
		[2,19]	=>	:ean13,
		[0,20]	=>	:cl_status,
		[2,20]	=>	:registration_count,
		[0,21]	=>	:generic_type,
		[2,21]	=>	:complementary_type,
		[1,22]	=>	:patinfo_stats,
		[1,23]	=>	:fipi_overview,
		[1,24,0]=>	:submit,
		[1,24,1]=>	:delete_item,
