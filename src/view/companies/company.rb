...
class AjaxPharmaCompanyForm < AjaxCompanyForm
	COMPONENTS = {
		...
		[0,6]		=>	:disable_autoinvoice,
		[2,6]		=>	:pref_invoice_date,
		[0,7]		=>	:invoice_htmlinfos,
		[2,7]		=>	:patinfo_price,
		[2,8]		=>	:index_invoice_date,
		[0,9]		=>	:index_price,
		[2,9]		=>	:index_package_price,
		[0,10]		=>	:address,
		[0,11]		=>	:plz,
		[2,11]		=>	:city,
		[0,12]		=>	:fon,
		...
		[2,16]	=>	:ean13,
		[0,17]	=>	:cl_status,
		[2,17]	=>	:registration_count,
		[0,18]	=>	:generic_type,
		[2,18]	=>	:complementary_type,
		[1,19]	=>	:patinfo_stats,
		[1,20]	=>	:fipi_overview,
		[1,21,0]=>	:submit,
		[1,21,1]=>	:delete_item,
