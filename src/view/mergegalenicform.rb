#!/usr/bin/env ruby
# MergeGalenicFormView -- oddb -- 04.04.2003 -- hwyss@ywesee.com 
...
module ODDB
	class MergeGalenicFormForm < Form
	...
	class MergeGalenicFormView < PrivateTemplate
		CONTENT = MergeGalenicFormComposite
