...
# ODDB::Registration -- oddb.org -- 08.04.2013 -- yasaka@ywesee.com
...
module ODDB
  class RegistrationCommon
    ...
    check_accessor_list = {
      ...
      revision_date: ["Date", "DateTime"],
      indication: "ODDB::Indication",
      expiration_date: ["Date", "DateTime"],
      inactive_date: ["Date", "DateTime"],
      manual_inactive_date: ["Date", "DateTime"],
      deactivate_fachinfo: ["Date", "DateTime"],
      activate_fachinfo: ["Date", "DateTime"],
      market_date: ["Date", "DateTime"],
    ...
    alias_method :pointer_descr, :iksnr
    SEQUENCE = Sequence
